defmodule DeeperHub.WebInterface.Resources.SysSeoLinksResource do
  @moduledoc """
  Recurso REST para sys_seo_links.
  Fornece endpoints para gerenciar sys_seo_links.
  ...
  alias DeeperHub.Core.Data.Schemas.SysSeoLinks, as: Schema
  
  @resource_name "sys_seo_link"
