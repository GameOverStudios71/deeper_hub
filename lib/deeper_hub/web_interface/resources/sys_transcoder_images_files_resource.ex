defmodule DeeperHub.WebInterface.Resources.SysTranscoderImagesFilesResource do
  @moduledoc """
  Recurso REST para sys_transcoder_images_files.
  Fornece endpoints para gerenciar sys_transcoder_images_files.
  ...
  alias DeeperHub.Core.Data.Schemas.SysTranscoderImagesFiles, as: Schema
  
  @resource_name "sys_transcoder_images_file"
