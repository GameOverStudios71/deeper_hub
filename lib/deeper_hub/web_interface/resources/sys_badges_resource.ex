defmodule DeeperHub.WebInterface.Resources.SysBadgesResource do
  @moduledoc """
  Recurso REST para sys_badges.
  Fornece endpoints para gerenciar sys_badges.
  ...
  alias DeeperHub.Core.Data.Schemas.SysBadges, as: Schema
  
  @resource_name "sys_badge"
