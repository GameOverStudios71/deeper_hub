defmodule DeeperHub.WebInterface.Resources.SysLocalizationStringsResource do
  @moduledoc """
  Recurso REST para sys_localization_strings.
  Fornece endpoints para gerenciar sys_localization_strings.
  ...
  alias DeeperHub.Core.Data.Schemas.SysLocalizationStrings, as: Schema
  
  @resource_name "sys_localization_string"
