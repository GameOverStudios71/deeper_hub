defmodule DeeperHub.WebInterface.Resources.SysObjectsCaptchaResource do
  @moduledoc """
  Recurso REST para sys_objects_captchas.
  Fornece endpoints para gerenciar sys_objects_captchas.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsCaptcha, as: Schema
  
  @resource_name "sys_objects_captcha"
