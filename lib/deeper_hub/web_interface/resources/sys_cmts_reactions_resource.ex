defmodule DeeperHub.WebInterface.Resources.SysCmtsReactionsResource do
  @moduledoc """
  Recurso REST para sys_cmts_reactions.
  Fornece endpoints para gerenciar sys_cmts_reactions.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCmtsReactions, as: Schema
  
  @resource_name "sys_cmts_reaction"
