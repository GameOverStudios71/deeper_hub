defmodule DeeperHub.WebInterface.Resources.SysObjectsFileHandlersResource do
  @moduledoc """
  Recurso REST para sys_objects_file_handlers.
  Fornece endpoints para gerenciar sys_objects_file_handlers.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsFileHandlers, as: Schema
  
  @resource_name "sys_objects_file_handler"
