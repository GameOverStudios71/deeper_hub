defmodule DeeperHub.WebInterface.Resources.SysAgentsProviderTypesResource do
  @moduledoc """
  Recurso REST para sys_agents_provider_types.
  Fornece endpoints para gerenciar sys_agents_provider_types.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsProviderTypes, as: Schema
  
  @resource_name "sys_agents_provider_type"
