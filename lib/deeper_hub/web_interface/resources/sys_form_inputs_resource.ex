defmodule DeeperHub.WebInterface.Resources.SysFormInputsResource do
  @moduledoc """
  Recurso REST para sys_form_inputs.
  Fornece endpoints para gerenciar sys_form_inputs.
  ...
  alias DeeperHub.Core.Data.Schemas.SysFormInputs, as: Schema
  
  @resource_name "sys_form_input"
