defmodule DeeperHub.WebInterface.Resources.SysObjectsUploaderResource do
  @moduledoc """
  Recurso REST para sys_objects_uploaders.
  Fornece endpoints para gerenciar sys_objects_uploaders.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsUploader, as: Schema
  
  @resource_name "sys_objects_uploader"
