defmodule DeeperHub.WebInterface.Resources.SysRecommendationDataResource do
  @moduledoc """
  Recurso REST para sys_recommendation_datas.
  Fornece endpoints para gerenciar sys_recommendation_datas.
  ...
  alias DeeperHub.Core.Data.Schemas.SysRecommendationData, as: Schema
  
  @resource_name "sys_recommendation_data"
