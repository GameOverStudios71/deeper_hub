defmodule DeeperHub.WebInterface.Resources.SysObjectsMenuResource do
  @moduledoc """
  Recurso REST para sys_objects_menus.
  Fornece endpoints para gerenciar sys_objects_menus.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsMenu, as: Schema
  
  @resource_name "sys_objects_menu"
