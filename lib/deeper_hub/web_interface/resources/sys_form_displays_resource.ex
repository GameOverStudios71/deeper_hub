defmodule DeeperHub.WebInterface.Resources.SysFormDisplaysResource do
  @moduledoc """
  Recurso REST para sys_form_displays.
  Fornece endpoints para gerenciar sys_form_displays.
  ...
  alias DeeperHub.Core.Data.Schemas.SysFormDisplays, as: Schema
  
  @resource_name "sys_form_display"
