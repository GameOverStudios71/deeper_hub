defmodule DeeperHub.WebInterface.Resources.SysStdRolesActionsResource do
  @moduledoc """
  Recurso REST para sys_std_roles_actions.
  Fornece endpoints para gerenciar sys_std_roles_actions.
  ...
  alias DeeperHub.Core.Data.Schemas.SysStdRolesActions, as: Schema
  
  @resource_name "sys_std_roles_action"
