defmodule DeeperHub.WebInterface.Resources.BxChartsMostActiveProfilesResource do
  @moduledoc """
  Recurso REST para bx_charts_most_active_profiles.
  Fornece endpoints para gerenciar bx_charts_most_active_profiles.
  ...
  alias DeeperHub.Core.Data.Schemas.BxChartsMostActiveProfiles, as: Schema
  
  @resource_name "bx_charts_most_active_profile"
