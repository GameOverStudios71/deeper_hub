defmodule DeeperHub.WebInterface.Resources.SysProfilesConnRelationsResource do
  @moduledoc """
  Recurso REST para sys_profiles_conn_relations.
  Fornece endpoints para gerenciar sys_profiles_conn_relations.
  ...
  alias DeeperHub.Core.Data.Schemas.SysProfilesConnRelations, as: Schema
  
  @resource_name "sys_profiles_conn_relation"
