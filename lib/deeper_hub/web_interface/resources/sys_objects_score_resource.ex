defmodule DeeperHub.WebInterface.Resources.SysObjectsScoreResource do
  @moduledoc """
  Recurso REST para sys_objects_scores.
  Fornece endpoints para gerenciar sys_objects_scores.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsScore, as: Schema
  
  @resource_name "sys_objects_score"
