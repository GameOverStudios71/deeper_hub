defmodule DeeperHub.WebInterface.Resources.SysModulesResource do
  @moduledoc """
  Recurso REST para sys_modules.
  Fornece endpoints para gerenciar sys_modules.
  ...
  alias DeeperHub.Core.Data.Schemas.SysModules, as: Schema
  
  @resource_name "sys_module"
