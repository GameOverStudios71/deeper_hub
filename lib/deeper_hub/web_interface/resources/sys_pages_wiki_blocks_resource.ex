defmodule DeeperHub.WebInterface.Resources.SysPagesWikiBlocksResource do
  @moduledoc """
  Recurso REST para sys_pages_wiki_blocks.
  Fornece endpoints para gerenciar sys_pages_wiki_blocks.
  ...
  alias DeeperHub.Core.Data.Schemas.SysPagesWikiBlocks, as: Schema
  
  @resource_name "sys_pages_wiki_block"
