defmodule DeeperHub.WebInterface.Resources.BxVideosVideosResource do
  @moduledoc """
  Recurso REST para bx_videos_videos.
  Fornece endpoints para gerenciar bx_videos_videos.
  ...
  alias DeeperHub.Core.Data.Schemas.BxVideosVideos, as: Schema
  
  @resource_name "bx_videos_video"
