defmodule DeeperHub.WebInterface.Resources.SysAgentsAutomatorsMessagesResource do
  @moduledoc """
  Recurso REST para sys_agents_automators_messages.
  Fornece endpoints para gerenciar sys_agents_automators_messages.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsAutomatorsMessages, as: Schema
  
  @resource_name "sys_agents_automators_message"
