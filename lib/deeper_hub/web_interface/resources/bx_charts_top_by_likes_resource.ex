defmodule DeeperHub.WebInterface.Resources.BxChartsTopByLikesResource do
  @moduledoc """
  Recurso REST para bx_charts_top_by_likes.
  Fornece endpoints para gerenciar bx_charts_top_by_likes.
  ...
  alias DeeperHub.Core.Data.Schemas.BxChartsTopByLikes, as: Schema
  
  @resource_name "bx_charts_top_by_like"
