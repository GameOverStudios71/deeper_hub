defmodule DeeperHub.WebInterface.Resources.SysSearchExtendedFieldsResource do
  @moduledoc """
  Recurso REST para sys_search_extended_fields.
  Fornece endpoints para gerenciar sys_search_extended_fields.
  ...
  alias DeeperHub.Core.Data.Schemas.SysSearchExtendedFields, as: Schema
  
  @resource_name "sys_search_extended_field"
