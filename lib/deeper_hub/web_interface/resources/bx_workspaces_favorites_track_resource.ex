defmodule DeeperHub.WebInterface.Resources.BxWorkspacesFavoritesTrackResource do
  @moduledoc """
  Recurso REST para bx_workspaces_favorites_tracks.
  Fornece endpoints para gerenciar bx_workspaces_favorites_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.BxWorkspacesFavoritesTrack, as: Schema
  
  @resource_name "bx_workspaces_favorites_track"
