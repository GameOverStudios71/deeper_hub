defmodule DeeperHub.WebInterface.Resources.SysCmtsReportsResource do
  @moduledoc """
  Recurso REST para sys_cmts_reports.
  Fornece endpoints para gerenciar sys_cmts_reports.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCmtsReports, as: Schema
  
  @resource_name "sys_cmts_report"
