defmodule DeeperHub.WebInterface.Resources.BxOrganizationsMetaLocationsResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxOrganizationsMetaLocations, as: Schema
