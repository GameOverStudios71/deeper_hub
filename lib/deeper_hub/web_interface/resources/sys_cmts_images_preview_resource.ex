defmodule DeeperHub.WebInterface.Resources.SysCmtsImagesPreviewResource do
  @moduledoc """
  Recurso REST para sys_cmts_images_previews.
  Fornece endpoints para gerenciar sys_cmts_images_previews.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCmtsImagesPreview, as: Schema
  
  @resource_name "sys_cmts_images_preview"
