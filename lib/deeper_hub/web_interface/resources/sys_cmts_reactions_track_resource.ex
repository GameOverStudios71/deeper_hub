defmodule DeeperHub.WebInterface.Resources.SysCmtsReactionsTrackResource do
  @moduledoc """
  Recurso REST para sys_cmts_reactions_tracks.
  Fornece endpoints para gerenciar sys_cmts_reactions_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCmtsReactionsTrack, as: Schema
  
  @resource_name "sys_cmts_reactions_track"
