defmodule DeeperHub.WebInterface.Resources.SysOptionsResource do
  @moduledoc """
  Recurso REST para sys_options.
  Fornece endpoints para gerenciar sys_options.
  ...
  alias DeeperHub.Core.Data.Schemas.SysOptions, as: Schema
  
  @resource_name "sys_option"
