defmodule DeeperHub.WebInterface.Resources.SysObjectsCmtsResource do
  @moduledoc """
  Recurso REST para sys_objects_cmts.
  Fornece endpoints para gerenciar sys_objects_cmts.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsCmts, as: Schema
  
  @resource_name "sys_objects_cmt"
