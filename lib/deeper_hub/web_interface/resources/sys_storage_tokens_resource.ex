defmodule DeeperHub.WebInterface.Resources.SysStorageTokensResource do
  @moduledoc """
  Recurso REST para sys_storage_tokens.
  Fornece endpoints para gerenciar sys_storage_tokens.
  ...
  alias DeeperHub.Core.Data.Schemas.SysStorageTokens, as: Schema
  
  @resource_name "sys_storage_token"
