defmodule DeeperHub.WebInterface.Resources.SysStorageGhostsResource do
  @moduledoc """
  Recurso REST para sys_storage_ghosts.
  Fornece endpoints para gerenciar sys_storage_ghosts.
  ...
  alias DeeperHub.Core.Data.Schemas.SysStorageGhosts, as: Schema
  
  @resource_name "sys_storage_ghost"
