defmodule DeeperHub.WebInterface.Resources.BxWorkspacesReactionsResource do
  @moduledoc """
  Recurso REST para bx_workspaces_reactions.
  Fornece endpoints para gerenciar bx_workspaces_reactions.
  ...
  alias DeeperHub.Core.Data.Schemas.BxWorkspacesReactions, as: Schema
  
  @resource_name "bx_workspaces_reaction"
