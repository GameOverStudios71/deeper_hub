defmodule DeeperHub.WebInterface.Resources.BxVideosViewsTrackResource do
  @moduledoc """
  Recurso REST para bx_videos_views_tracks.
  Fornece endpoints para gerenciar bx_videos_views_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.BxVideosViewsTrack, as: Schema
  
  @resource_name "bx_videos_views_track"
