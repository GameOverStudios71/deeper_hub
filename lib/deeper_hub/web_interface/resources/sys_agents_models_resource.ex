defmodule DeeperHub.WebInterface.Resources.SysAgentsModelsResource do
  @moduledoc """
  Recurso REST para sys_agents_models.
  Fornece endpoints para gerenciar sys_agents_models.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsModels, as: Schema
  
  @resource_name "sys_agents_model"
