defmodule DeeperHub.WebInterface.Resources.BxVideosVotesTrackResource do
  @moduledoc """
  Recurso REST para bx_videos_votes_tracks.
  Fornece endpoints para gerenciar bx_videos_votes_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.BxVideosVotesTrack, as: Schema
  
  @resource_name "bx_videos_votes_track"
