defmodule DeeperHub.WebInterface.Resources.BxAntispamDisposableEmailDomainsResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxAntispamDisposableEmailDomains, as: Schema
