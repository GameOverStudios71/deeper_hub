defmodule DeeperHub.WebInterface.Resources.SysAclLevelsResource do
  @moduledoc """
  Recurso REST para sys_acl_levels.
  Fornece endpoints para gerenciar sys_acl_levels.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAclLevels, as: Schema
  
  @resource_name "sys_acl_level"
