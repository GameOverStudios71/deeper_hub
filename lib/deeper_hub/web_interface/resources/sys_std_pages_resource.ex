defmodule DeeperHub.WebInterface.Resources.SysStdPagesResource do
  @moduledoc """
  Recurso REST para sys_std_pages.
  Fornece endpoints para gerenciar sys_std_pages.
  ...
  alias DeeperHub.Core.Data.Schemas.SysStdPages, as: Schema
  
  @resource_name "sys_std_page"
