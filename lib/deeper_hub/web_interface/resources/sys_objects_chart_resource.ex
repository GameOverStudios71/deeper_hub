defmodule DeeperHub.WebInterface.Resources.SysObjectsChartResource do
  @moduledoc """
  Recurso REST para sys_objects_charts.
  Fornece endpoints para gerenciar sys_objects_charts.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsChart, as: Schema
  
  @resource_name "sys_objects_chart"
