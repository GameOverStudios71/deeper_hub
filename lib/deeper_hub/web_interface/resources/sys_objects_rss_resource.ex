defmodule DeeperHub.WebInterface.Resources.SysObjectsRssResource do
  @moduledoc """
  Recurso REST para sys_objects_rss.
  Fornece endpoints para gerenciar sys_objects_rss.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsRss, as: Schema
  
  @resource_name "sys_objects_rs"
