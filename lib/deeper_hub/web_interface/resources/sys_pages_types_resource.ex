defmodule DeeperHub.WebInterface.Resources.SysPagesTypesResource do
  @moduledoc """
  Recurso REST para sys_pages_types.
  Fornece endpoints para gerenciar sys_pages_types.
  ...
  alias DeeperHub.Core.Data.Schemas.SysPagesTypes, as: Schema
  
  @resource_name "sys_pages_type"
