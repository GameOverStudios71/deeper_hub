defmodule DeeperHub.WebInterface.Resources.SysApiOriginsResource do
  @moduledoc """
  Recurso REST para sys_api_origins.
  Fornece endpoints para gerenciar sys_api_origins.
  ...
  alias DeeperHub.Core.Data.Schemas.SysApiOrigins, as: Schema
  
  @resource_name "sys_api_origin"
