defmodule DeeperHub.WebInterface.Resources.SysAgentsProvidersResource do
  @moduledoc """
  Recurso REST para sys_agents_providers.
  Fornece endpoints para gerenciar sys_agents_providers.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsProviders, as: Schema
  
  @resource_name "sys_agents_provider"
