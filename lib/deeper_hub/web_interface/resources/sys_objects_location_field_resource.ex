defmodule DeeperHub.WebInterface.Resources.SysObjectsLocationFieldResource do
  @moduledoc """
  Recurso REST para sys_objects_location_fields.
  Fornece endpoints para gerenciar sys_objects_location_fields.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsLocationField, as: Schema
  
  @resource_name "sys_objects_location_field"
