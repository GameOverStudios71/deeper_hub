defmodule DeeperHub.WebInterface.Resources.SysPrivacyGroupsResource do
  @moduledoc """
  Recurso REST para sys_privacy_groups.
  Fornece endpoints para gerenciar sys_privacy_groups.
  ...
  alias DeeperHub.Core.Data.Schemas.SysPrivacyGroups, as: Schema
  
  @resource_name "sys_privacy_group"
