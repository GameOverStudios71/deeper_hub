defmodule DeeperHub.WebInterface.Resources.SysPreloaderResource do
  @moduledoc """
  Recurso REST para sys_preloaders.
  Fornece endpoints para gerenciar sys_preloaders.
  ...
  alias DeeperHub.Core.Data.Schemas.SysPreloader, as: Schema
  
  @resource_name "sys_preloader"
