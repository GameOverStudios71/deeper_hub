defmodule DeeperHub.WebInterface.Resources.SysAclActionsResource do
  @moduledoc """
  Recurso REST para sys_acl_actions.
  Fornece endpoints para gerenciar sys_acl_actions.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAclActions, as: Schema
  
  @resource_name "sys_acl_action"
