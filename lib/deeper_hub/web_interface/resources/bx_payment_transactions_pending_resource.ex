defmodule DeeperHub.WebInterface.Resources.BxPaymentTransactionsPendingResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxPaymentTransactionsPending, as: Schema
