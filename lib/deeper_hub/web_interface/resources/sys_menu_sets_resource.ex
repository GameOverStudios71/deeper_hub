defmodule DeeperHub.WebInterface.Resources.SysMenuSetsResource do
  @moduledoc """
  Recurso REST para sys_menu_sets.
  Fornece endpoints para gerenciar sys_menu_sets.
  ...
  alias DeeperHub.Core.Data.Schemas.SysMenuSets, as: Schema
  
  @resource_name "sys_menu_set"
