defmodule DeeperHub.WebInterface.Resources.SysCmtsVotesResource do
  @moduledoc """
  Recurso REST para sys_cmts_votes.
  Fornece endpoints para gerenciar sys_cmts_votes.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCmtsVotes, as: Schema
  
  @resource_name "sys_cmts_vote"
