defmodule DeeperHub.WebInterface.Resources.SysProfilesTrackResource do
  @moduledoc """
  Recurso REST para sys_profiles_tracks.
  Fornece endpoints para gerenciar sys_profiles_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.SysProfilesTrack, as: Schema
  
  @resource_name "sys_profiles_track"
