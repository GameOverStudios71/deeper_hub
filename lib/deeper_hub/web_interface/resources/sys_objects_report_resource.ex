defmodule DeeperHub.WebInterface.Resources.SysObjectsReportResource do
  @moduledoc """
  Recurso REST para sys_objects_reports.
  Fornece endpoints para gerenciar sys_objects_reports.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsReport, as: Schema
  
  @resource_name "sys_objects_report"
