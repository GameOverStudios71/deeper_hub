defmodule DeeperHub.WebInterface.Resources.SysRecommendationCriteriaResource do
  @moduledoc """
  Recurso REST para sys_recommendation_criterias.
  Fornece endpoints para gerenciar sys_recommendation_criterias.
  ...
  alias DeeperHub.Core.Data.Schemas.SysRecommendationCriteria, as: Schema
  
  @resource_name "sys_recommendation_criteria"
