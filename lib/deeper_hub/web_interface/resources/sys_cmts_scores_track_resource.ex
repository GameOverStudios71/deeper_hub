defmodule DeeperHub.WebInterface.Resources.SysCmtsScoresTrackResource do
  @moduledoc """
  Recurso REST para sys_cmts_scores_tracks.
  Fornece endpoints para gerenciar sys_cmts_scores_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCmtsScoresTrack, as: Schema
  
  @resource_name "sys_cmts_scores_track"
