defmodule DeeperHub.WebInterface.Resources.BxCoursesContentNodes2usersResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxCoursesContentNodes2users, as: Schema
