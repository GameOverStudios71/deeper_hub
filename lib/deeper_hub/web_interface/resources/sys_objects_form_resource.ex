defmodule DeeperHub.WebInterface.Resources.SysObjectsFormResource do
  @moduledoc """
  Recurso REST para sys_objects_forms.
  Fornece endpoints para gerenciar sys_objects_forms.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsForm, as: Schema
  
  @resource_name "sys_objects_form"
