defmodule DeeperHub.WebInterface.Resources.SysLocalizationKeysResource do
  @moduledoc """
  Recurso REST para sys_localization_keys.
  Fornece endpoints para gerenciar sys_localization_keys.
  ...
  alias DeeperHub.Core.Data.Schemas.SysLocalizationKeys, as: Schema
  
  @resource_name "sys_localization_key"
