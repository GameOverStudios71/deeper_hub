defmodule DeeperHub.WebInterface.Resources.SysStorageDeletionsResource do
  @moduledoc """
  Recurso REST para sys_storage_deletions.
  Fornece endpoints para gerenciar sys_storage_deletions.
  ...
  alias DeeperHub.Core.Data.Schemas.SysStorageDeletions, as: Schema
  
  @resource_name "sys_storage_deletion"
