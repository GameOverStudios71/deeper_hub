defmodule DeeperHub.WebInterface.Resources.BxWorkspacesDataResource do
  @moduledoc """
  Recurso REST para bx_workspaces_datas.
  Fornece endpoints para gerenciar bx_workspaces_datas.
  ...
  alias DeeperHub.Core.Data.Schemas.BxWorkspacesData, as: Schema
  
  @resource_name "bx_workspaces_data"
