defmodule DeeperHub.WebInterface.Resources.BxTimelinePollsAnswersVotesTrackResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxTimelinePollsAnswersVotesTrack, as: Schema
