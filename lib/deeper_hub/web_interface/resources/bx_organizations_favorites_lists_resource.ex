defmodule DeeperHub.WebInterface.Resources.BxOrganizationsFavoritesListsResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxOrganizationsFavoritesLists, as: Schema
