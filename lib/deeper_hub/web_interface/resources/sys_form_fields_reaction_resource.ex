defmodule DeeperHub.WebInterface.Resources.SysFormFieldsReactionResource do
  @moduledoc """
  Recurso REST para sys_form_fields_reactions.
  Fornece endpoints para gerenciar sys_form_fields_reactions.
  ...
  alias DeeperHub.Core.Data.Schemas.SysFormFieldsReaction, as: Schema
  
  @resource_name "sys_form_fields_reaction"
