defmodule DeeperHub.WebInterface.Resources.BxWorkspacesVotesResource do
  @moduledoc """
  Recurso REST para bx_workspaces_votes.
  Fornece endpoints para gerenciar bx_workspaces_votes.
  ...
  alias DeeperHub.Core.Data.Schemas.BxWorkspacesVotes, as: Schema
  
  @resource_name "bx_workspaces_vote"
