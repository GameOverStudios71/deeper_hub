defmodule DeeperHub.WebInterface.Resources.SysAccountsPicturesResizedResource do
  @moduledoc """
  Recurso REST para sys_accounts_pictures_resizeds.
  Fornece endpoints para gerenciar sys_accounts_pictures_resizeds.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAccountsPicturesResized, as: Schema
  
  @resource_name "sys_accounts_pictures_resized"
