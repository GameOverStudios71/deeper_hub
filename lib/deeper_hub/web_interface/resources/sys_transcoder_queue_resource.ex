defmodule DeeperHub.WebInterface.Resources.SysTranscoderQueueResource do
  @moduledoc """
  Recurso REST para sys_transcoder_queues.
  Fornece endpoints para gerenciar sys_transcoder_queues.
  ...
  alias DeeperHub.Core.Data.Schemas.SysTranscoderQueue, as: Schema
  
  @resource_name "sys_transcoder_queue"
