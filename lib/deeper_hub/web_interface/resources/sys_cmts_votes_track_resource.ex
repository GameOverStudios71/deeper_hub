defmodule DeeperHub.WebInterface.Resources.SysCmtsVotesTrackResource do
  @moduledoc """
  Recurso REST para sys_cmts_votes_tracks.
  Fornece endpoints para gerenciar sys_cmts_votes_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCmtsVotesTrack, as: Schema
  
  @resource_name "sys_cmts_votes_track"
