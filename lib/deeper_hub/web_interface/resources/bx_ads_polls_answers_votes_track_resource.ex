defmodule DeeperHub.WebInterface.Resources.BxAdsPollsAnswersVotesTrackResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxAdsPollsAnswersVotesTrack, as: Schema
