defmodule DeeperHub.WebInterface.Resources.SysAuditResource do
  @moduledoc """
  Recurso REST para sys_audits.
  Fornece endpoints para gerenciar sys_audits.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAudit, as: Schema
  
  @resource_name "sys_audit"
