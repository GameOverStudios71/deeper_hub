defmodule DeeperHub.WebInterface.Resources.SysAgentsAssistantsChatsFilesResource do
  @moduledoc """
  Recurso REST para sys_agents_assistants_chats_files.
  Fornece endpoints para gerenciar sys_agents_assistants_chats_files.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsAssistantsChatsFiles, as: Schema
  
  @resource_name "sys_agents_assistants_chats_file"
