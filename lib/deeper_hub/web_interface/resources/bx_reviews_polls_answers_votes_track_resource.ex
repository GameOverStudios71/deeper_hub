defmodule DeeperHub.WebInterface.Resources.BxReviewsPollsAnswersVotesTrackResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxReviewsPollsAnswersVotesTrack, as: Schema
