defmodule DeeperHub.WebInterface.Resources.SysAclActionsTrackResource do
  @moduledoc """
  Recurso REST para sys_acl_actions_tracks.
  Fornece endpoints para gerenciar sys_acl_actions_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAclActionsTrack, as: Schema
  
  @resource_name "sys_acl_actions_track"
