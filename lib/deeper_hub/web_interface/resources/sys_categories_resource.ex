defmodule DeeperHub.WebInterface.Resources.SysCategoriesResource do
  @moduledoc """
  Recurso REST para sys_categories.
  Fornece endpoints para gerenciar sys_categories.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCategories, as: Schema
  
  @resource_name "sys_categorie"
