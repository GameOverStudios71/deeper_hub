defmodule DeeperHub.WebInterface.Resources.BxWorkspacesVotesTrackResource do
  @moduledoc """
  Recurso REST para bx_workspaces_votes_tracks.
  Fornece endpoints para gerenciar bx_workspaces_votes_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.BxWorkspacesVotesTrack, as: Schema
  
  @resource_name "bx_workspaces_votes_track"
