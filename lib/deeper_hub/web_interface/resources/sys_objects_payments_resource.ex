defmodule DeeperHub.WebInterface.Resources.SysObjectsPaymentsResource do
  @moduledoc """
  Recurso REST para sys_objects_payments.
  Fornece endpoints para gerenciar sys_objects_payments.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsPayments, as: Schema
  
  @resource_name "sys_objects_payment"
