defmodule DeeperHub.WebInterface.Resources.SysTranscoderVideosFilesResource do
  @moduledoc """
  Recurso REST para sys_transcoder_videos_files.
  Fornece endpoints para gerenciar sys_transcoder_videos_files.
  ...
  alias DeeperHub.Core.Data.Schemas.SysTranscoderVideosFiles, as: Schema
  
  @resource_name "sys_transcoder_videos_file"
