defmodule DeeperHub.WebInterface.Resources.BxOrganizationsMetaMentionsResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxOrganizationsMetaMentions, as: Schema
