defmodule DeeperHub.WebInterface.Resources.BxWorkspacesViewsTrackResource do
  @moduledoc """
  Recurso REST para bx_workspaces_views_tracks.
  Fornece endpoints para gerenciar bx_workspaces_views_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.BxWorkspacesViewsTrack, as: Schema
  
  @resource_name "bx_workspaces_views_track"
