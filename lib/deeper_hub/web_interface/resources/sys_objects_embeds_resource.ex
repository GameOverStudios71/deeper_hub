defmodule DeeperHub.WebInterface.Resources.SysObjectsEmbedsResource do
  @moduledoc """
  Recurso REST para sys_objects_embeds.
  Fornece endpoints para gerenciar sys_objects_embeds.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsEmbeds, as: Schema
  
  @resource_name "sys_objects_embed"
