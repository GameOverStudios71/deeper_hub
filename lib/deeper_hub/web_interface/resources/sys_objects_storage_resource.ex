defmodule DeeperHub.WebInterface.Resources.SysObjectsStorageResource do
  @moduledoc """
  Recurso REST para sys_objects_storages.
  Fornece endpoints para gerenciar sys_objects_storages.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsStorage, as: Schema
  
  @resource_name "sys_objects_storage"
