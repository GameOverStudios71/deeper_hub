defmodule DeeperHub.WebInterface.Resources.SysAgentsProviderOptionsResource do
  @moduledoc """
  Recurso REST para sys_agents_provider_options.
  Fornece endpoints para gerenciar sys_agents_provider_options.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsProviderOptions, as: Schema
  
  @resource_name "sys_agents_provider_option"
