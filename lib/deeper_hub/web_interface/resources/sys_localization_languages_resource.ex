defmodule DeeperHub.WebInterface.Resources.SysLocalizationLanguagesResource do
  @moduledoc """
  Recurso REST para sys_localization_languages.
  Fornece endpoints para gerenciar sys_localization_languages.
  ...
  alias DeeperHub.Core.Data.Schemas.SysLocalizationLanguages, as: Schema
  
  @resource_name "sys_localization_language"
