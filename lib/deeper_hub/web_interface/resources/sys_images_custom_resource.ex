defmodule DeeperHub.WebInterface.Resources.SysImagesCustomResource do
  @moduledoc """
  Recurso REST para sys_images_customs.
  Fornece endpoints para gerenciar sys_images_customs.
  ...
  alias DeeperHub.Core.Data.Schemas.SysImagesCustom, as: Schema
  
  @resource_name "sys_images_custom"
