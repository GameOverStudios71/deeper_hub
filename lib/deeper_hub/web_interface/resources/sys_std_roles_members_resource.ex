defmodule DeeperHub.WebInterface.Resources.SysStdRolesMembersResource do
  @moduledoc """
  Recurso REST para sys_std_roles_members.
  Fornece endpoints para gerenciar sys_std_roles_members.
  ...
  alias DeeperHub.Core.Data.Schemas.SysStdRolesMembers, as: Schema
  
  @resource_name "sys_std_roles_member"
