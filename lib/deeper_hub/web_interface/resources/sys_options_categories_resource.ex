defmodule DeeperHub.WebInterface.Resources.SysOptionsCategoriesResource do
  @moduledoc """
  Recurso REST para sys_options_categories.
  Fornece endpoints para gerenciar sys_options_categories.
  ...
  alias DeeperHub.Core.Data.Schemas.SysOptionsCategories, as: Schema
  
  @resource_name "sys_options_categorie"
