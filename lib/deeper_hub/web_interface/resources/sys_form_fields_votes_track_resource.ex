defmodule DeeperHub.WebInterface.Resources.SysFormFieldsVotesTrackResource do
  @moduledoc """
  Recurso REST para sys_form_fields_votes_tracks.
  Fornece endpoints para gerenciar sys_form_fields_votes_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.SysFormFieldsVotesTrack, as: Schema
  
  @resource_name "sys_form_fields_votes_track"
