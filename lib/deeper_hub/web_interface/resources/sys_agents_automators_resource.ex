defmodule DeeperHub.WebInterface.Resources.SysAgentsAutomatorsResource do
  @moduledoc """
  Recurso REST para sys_agents_automators.
  Fornece endpoints para gerenciar sys_agents_automators.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsAutomators, as: Schema
  
  @resource_name "sys_agents_automator"
