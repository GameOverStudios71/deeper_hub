defmodule DeeperHub.WebInterface.Resources.SysObjectsLocationMapResource do
  @moduledoc """
  Recurso REST para sys_objects_location_maps.
  Fornece endpoints para gerenciar sys_objects_location_maps.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsLocationMap, as: Schema
  
  @resource_name "sys_objects_location_map"
