defmodule DeeperHub.WebInterface.Resources.SysObjectsFeatureResource do
  @moduledoc """
  Recurso REST para sys_objects_features.
  Fornece endpoints para gerenciar sys_objects_features.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsFeature, as: Schema
  
  @resource_name "sys_objects_feature"
