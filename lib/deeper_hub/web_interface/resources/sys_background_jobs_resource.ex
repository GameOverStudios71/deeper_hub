defmodule DeeperHub.WebInterface.Resources.SysBackgroundJobsResource do
  @moduledoc """
  Recurso REST para sys_background_jobs.
  Fornece endpoints para gerenciar sys_background_jobs.
  ...
  alias DeeperHub.Core.Data.Schemas.SysBackgroundJobs, as: Schema
  
  @resource_name "sys_background_job"
