defmodule DeeperHub.WebInterface.Resources.SysOptionsMixes2optionsResource do
  @moduledoc """
  Recurso REST para sys_options_mixes2options.
  Fornece endpoints para gerenciar sys_options_mixes2options.
  ...
  alias DeeperHub.Core.Data.Schemas.SysOptionsMixes2options, as: Schema
  
  @resource_name "sys_options_mixes2option"
