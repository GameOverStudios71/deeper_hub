defmodule DeeperHub.WebInterface.Resources.SysTranscoderAudioFilesResource do
  @moduledoc """
  Recurso REST para sys_transcoder_audio_files.
  Fornece endpoints para gerenciar sys_transcoder_audio_files.
  ...
  alias DeeperHub.Core.Data.Schemas.SysTranscoderAudioFiles, as: Schema
  
  @resource_name "sys_transcoder_audio_file"
