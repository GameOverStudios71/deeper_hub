defmodule DeeperHub.WebInterface.Resources.SysEmbededDataResource do
  @moduledoc """
  Recurso REST para sys_embeded_datas.
  Fornece endpoints para gerenciar sys_embeded_datas.
  ...
  alias DeeperHub.Core.Data.Schemas.SysEmbededData, as: Schema
  
  @resource_name "sys_embeded_data"
