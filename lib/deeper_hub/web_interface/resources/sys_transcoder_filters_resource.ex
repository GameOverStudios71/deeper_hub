defmodule DeeperHub.WebInterface.Resources.SysTranscoderFiltersResource do
  @moduledoc """
  Recurso REST para sys_transcoder_filters.
  Fornece endpoints para gerenciar sys_transcoder_filters.
  ...
  alias DeeperHub.Core.Data.Schemas.SysTranscoderFilters, as: Schema
  
  @resource_name "sys_transcoder_filter"
