defmodule DeeperHub.WebInterface.Resources.SysPrivacyGroupsCustomResource do
  @moduledoc """
  Recurso REST para sys_privacy_groups_customs.
  Fornece endpoints para gerenciar sys_privacy_groups_customs.
  ...
  alias DeeperHub.Core.Data.Schemas.SysPrivacyGroupsCustom, as: Schema
  
  @resource_name "sys_privacy_groups_custom"
