defmodule DeeperHub.WebInterface.Resources.SysCmtsIdsResource do
  @moduledoc """
  Recurso REST para sys_cmts_ids.
  Fornece endpoints para gerenciar sys_cmts_ids.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCmtsIds, as: Schema
  
  @resource_name "sys_cmts_id"
