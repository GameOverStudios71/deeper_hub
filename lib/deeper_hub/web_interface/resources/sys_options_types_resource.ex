defmodule DeeperHub.WebInterface.Resources.SysOptionsTypesResource do
  @moduledoc """
  Recurso REST para sys_options_types.
  Fornece endpoints para gerenciar sys_options_types.
  ...
  alias DeeperHub.Core.Data.Schemas.SysOptionsTypes, as: Schema
  
  @resource_name "sys_options_type"
