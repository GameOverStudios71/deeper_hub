defmodule DeeperHub.WebInterface.Resources.SysPagesBlocksResource do
  @moduledoc """
  Recurso REST para sys_pages_blocks.
  Fornece endpoints para gerenciar sys_pages_blocks.
  ...
  alias DeeperHub.Core.Data.Schemas.SysPagesBlocks, as: Schema
  
  @resource_name "sys_pages_block"
