defmodule DeeperHub.WebInterface.Resources.SysFilesResource do
  @moduledoc """
  Recurso REST para sys_files.
  Fornece endpoints para gerenciar sys_files.
  ...
  alias DeeperHub.Core.Data.Schemas.SysFiles, as: Schema
  
  @resource_name "sys_file"
