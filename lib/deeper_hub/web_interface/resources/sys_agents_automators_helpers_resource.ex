defmodule DeeperHub.WebInterface.Resources.SysAgentsAutomatorsHelpersResource do
  @moduledoc """
  Recurso REST para sys_agents_automators_helpers.
  Fornece endpoints para gerenciar sys_agents_automators_helpers.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsAutomatorsHelpers, as: Schema
  
  @resource_name "sys_agents_automators_helper"
