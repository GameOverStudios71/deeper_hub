defmodule DeeperHub.WebInterface.Resources.BxCoursesContentData2usersResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxCoursesContentData2users, as: Schema
