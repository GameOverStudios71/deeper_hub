defmodule DeeperHub.WebInterface.Resources.SysStdRolesActions2rolesResource do
  @moduledoc """
  Recurso REST para sys_std_roles_actions2roles.
  Fornece endpoints para gerenciar sys_std_roles_actions2roles.
  ...
  alias DeeperHub.Core.Data.Schemas.SysStdRolesActions2roles, as: Schema
  
  @resource_name "sys_std_roles_actions2role"
