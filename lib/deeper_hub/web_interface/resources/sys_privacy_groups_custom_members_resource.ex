defmodule DeeperHub.WebInterface.Resources.SysPrivacyGroupsCustomMembersResource do
  @moduledoc """
  Recurso REST para sys_privacy_groups_custom_members.
  Fornece endpoints para gerenciar sys_privacy_groups_custom_members.
  ...
  alias DeeperHub.Core.Data.Schemas.SysPrivacyGroupsCustomMembers, as: Schema
  
  @resource_name "sys_privacy_groups_custom_member"
