defmodule DeeperHub.WebInterface.Resources.BxOrganizationsMetaKeywordsResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxOrganizationsMetaKeywords, as: Schema
