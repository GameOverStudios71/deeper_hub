defmodule DeeperHub.WebInterface.Resources.BxNotificationsEvents2usersResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxNotificationsEvents2users, as: Schema
