defmodule DeeperHub.WebInterface.Resources.BxAlbumsMetaKeywordsMediaCameraResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxAlbumsMetaKeywordsMediaCamera, as: Schema
