defmodule DeeperHub.WebInterface.Resources.SysStorageUserQuotasResource do
  @moduledoc """
  Recurso REST para sys_storage_user_quotas.
  Fornece endpoints para gerenciar sys_storage_user_quotas.
  ...
  alias DeeperHub.Core.Data.Schemas.SysStorageUserQuotas, as: Schema
  
  @resource_name "sys_storage_user_quota"
