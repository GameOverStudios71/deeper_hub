defmodule DeeperHub.WebInterface.Resources.SysAclLevelsMembersResource do
  @moduledoc """
  Recurso REST para sys_acl_levels_members.
  Fornece endpoints para gerenciar sys_acl_levels_members.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAclLevelsMembers, as: Schema
  
  @resource_name "sys_acl_levels_member"
