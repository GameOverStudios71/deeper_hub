defmodule DeeperHub.WebInterface.Resources.SysTranscoderQueueFilesResource do
  @moduledoc """
  Recurso REST para sys_transcoder_queue_files.
  Fornece endpoints para gerenciar sys_transcoder_queue_files.
  ...
  alias DeeperHub.Core.Data.Schemas.SysTranscoderQueueFiles, as: Schema
  
  @resource_name "sys_transcoder_queue_file"
