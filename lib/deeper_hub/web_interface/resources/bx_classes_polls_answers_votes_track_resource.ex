defmodule DeeperHub.WebInterface.Resources.BxClassesPollsAnswersVotesTrackResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxClassesPollsAnswersVotesTrack, as: Schema
