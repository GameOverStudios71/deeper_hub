defmodule DeeperHub.WebInterface.Resources.SysAgentsProvidersValuesResource do
  @moduledoc """
  Recurso REST para sys_agents_providers_values.
  Fornece endpoints para gerenciar sys_agents_providers_values.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsProvidersValues, as: Schema
  
  @resource_name "sys_agents_providers_value"
