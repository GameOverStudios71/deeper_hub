defmodule DeeperHub.WebInterface.Resources.SysCmtsScoresResource do
  @moduledoc """
  Recurso REST para sys_cmts_scores.
  Fornece endpoints para gerenciar sys_cmts_scores.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCmtsScores, as: Schema
  
  @resource_name "sys_cmts_score"
