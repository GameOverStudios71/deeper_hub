defmodule DeeperHub.WebInterface.Resources.SysOptionsMixesResource do
  @moduledoc """
  Recurso REST para sys_options_mixes.
  Fornece endpoints para gerenciar sys_options_mixes.
  ...
  alias DeeperHub.Core.Data.Schemas.SysOptionsMixes, as: Schema
  
  @resource_name "sys_options_mixe"
