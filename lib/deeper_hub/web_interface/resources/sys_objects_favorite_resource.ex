defmodule DeeperHub.WebInterface.Resources.SysObjectsFavoriteResource do
  @moduledoc """
  Recurso REST para sys_objects_favorites.
  Fornece endpoints para gerenciar sys_objects_favorites.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsFavorite, as: Schema
  
  @resource_name "sys_objects_favorite"
