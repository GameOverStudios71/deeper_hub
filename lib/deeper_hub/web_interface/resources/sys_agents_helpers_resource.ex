defmodule DeeperHub.WebInterface.Resources.SysAgentsHelpersResource do
  @moduledoc """
  Recurso REST para sys_agents_helpers.
  Fornece endpoints para gerenciar sys_agents_helpers.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsHelpers, as: Schema
  
  @resource_name "sys_agents_helper"
