defmodule DeeperHub.WebInterface.Resources.SysAgentsAssistantsChatsResource do
  @moduledoc """
  Recurso REST para sys_agents_assistants_chats.
  Fornece endpoints para gerenciar sys_agents_assistants_chats.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsAssistantsChats, as: Schema
  
  @resource_name "sys_agents_assistants_chat"
