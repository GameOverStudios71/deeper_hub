defmodule DeeperHub.WebInterface.Resources.SysObjectsMetatagsResource do
  @moduledoc """
  Recurso REST para sys_objects_metatags.
  Fornece endpoints para gerenciar sys_objects_metatags.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsMetatags, as: Schema
  
  @resource_name "sys_objects_metatag"
