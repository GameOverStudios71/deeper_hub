defmodule DeeperHub.WebInterface.Resources.SysAccountsPicturesResource do
  @moduledoc """
  Recurso REST para sys_accounts_pictures.
  Fornece endpoints para gerenciar sys_accounts_pictures.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAccountsPictures, as: Schema
  
  @resource_name "sys_accounts_picture"
