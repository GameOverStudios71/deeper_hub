defmodule DeeperHub.WebInterface.Resources.SysPermalinksResource do
  @moduledoc """
  Recurso REST para sys_permalinks.
  Fornece endpoints para gerenciar sys_permalinks.
  ...
  alias DeeperHub.Core.Data.Schemas.SysPermalinks, as: Schema
  
  @resource_name "sys_permalink"
