defmodule DeeperHub.WebInterface.Resources.SysFormPreListsResource do
  @moduledoc """
  Recurso REST para sys_form_pre_lists.
  Fornece endpoints para gerenciar sys_form_pre_lists.
  ...
  alias DeeperHub.Core.Data.Schemas.SysFormPreLists, as: Schema
  
  @resource_name "sys_form_pre_list"
