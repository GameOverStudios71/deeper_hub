defmodule DeeperHub.WebInterface.Resources.SysMenuTemplatesResource do
  @moduledoc """
  Recurso REST para sys_menu_templates.
  Fornece endpoints para gerenciar sys_menu_templates.
  ...
  alias DeeperHub.Core.Data.Schemas.SysMenuTemplates, as: Schema
  
  @resource_name "sys_menu_template"
