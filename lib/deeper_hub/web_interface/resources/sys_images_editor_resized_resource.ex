defmodule DeeperHub.WebInterface.Resources.SysImagesEditorResizedResource do
  @moduledoc """
  Recurso REST para sys_images_editor_resizeds.
  Fornece endpoints para gerenciar sys_images_editor_resizeds.
  ...
  alias DeeperHub.Core.Data.Schemas.SysImagesEditorResized, as: Schema
  
  @resource_name "sys_images_editor_resized"
