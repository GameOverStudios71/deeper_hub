defmodule DeeperHub.WebInterface.Resources.SysLabelsResource do
  @moduledoc """
  Recurso REST para sys_labels.
  Fornece endpoints para gerenciar sys_labels.
  ...
  alias DeeperHub.Core.Data.Schemas.SysLabels, as: Schema
  
  @resource_name "sys_label"
