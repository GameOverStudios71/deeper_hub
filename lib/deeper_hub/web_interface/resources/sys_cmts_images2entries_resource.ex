defmodule DeeperHub.WebInterface.Resources.SysCmtsImages2entriesResource do
  @moduledoc """
  Recurso REST para sys_cmts_images2entries.
  Fornece endpoints para gerenciar sys_cmts_images2entries.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCmtsImages2entries, as: Schema
  
  @resource_name "sys_cmts_images2entrie"
