defmodule DeeperHub.WebInterface.Resources.SysAgentsAssistantsFilesResource do
  @moduledoc """
  Recurso REST para sys_agents_assistants_files.
  Fornece endpoints para gerenciar sys_agents_assistants_files.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsAssistantsFiles, as: Schema
  
  @resource_name "sys_agents_assistants_file"
