defmodule DeeperHub.WebInterface.Resources.SysObjectsViewResource do
  @moduledoc """
  Recurso REST para sys_objects_views.
  Fornece endpoints para gerenciar sys_objects_views.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsView, as: Schema
  
  @resource_name "sys_objects_view"
