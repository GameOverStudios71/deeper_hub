defmodule DeeperHub.WebInterface.Resources.BxWorkspacesReactionsTrackResource do
  @moduledoc """
  Recurso REST para bx_workspaces_reactions_tracks.
  Fornece endpoints para gerenciar bx_workspaces_reactions_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.BxWorkspacesReactionsTrack, as: Schema
  
  @resource_name "bx_workspaces_reactions_track"
