defmodule DeeperHub.WebInterface.Resources.SysQueueEmailResource do
  @moduledoc """
  Recurso REST para sys_queue_emails.
  Fornece endpoints para gerenciar sys_queue_emails.
  ...
  alias DeeperHub.Core.Data.Schemas.SysQueueEmail, as: Schema
  
  @resource_name "sys_queue_email"
