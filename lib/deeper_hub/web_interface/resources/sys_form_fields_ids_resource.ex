defmodule DeeperHub.WebInterface.Resources.SysFormFieldsIdsResource do
  @moduledoc """
  Recurso REST para sys_form_fields_ids.
  Fornece endpoints para gerenciar sys_form_fields_ids.
  ...
  alias DeeperHub.Core.Data.Schemas.SysFormFieldsIds, as: Schema
  
  @resource_name "sys_form_fields_id"
