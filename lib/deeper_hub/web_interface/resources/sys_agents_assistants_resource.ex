defmodule DeeperHub.WebInterface.Resources.SysAgentsAssistantsResource do
  @moduledoc """
  Recurso REST para sys_agents_assistants.
  Fornece endpoints para gerenciar sys_agents_assistants.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsAssistants, as: Schema
  
  @resource_name "sys_agents_assistant"
