defmodule DeeperHub.WebInterface.Resources.SysAlertsCacheTriggersResource do
  @moduledoc """
  Recurso REST para sys_alerts_cache_triggers.
  Fornece endpoints para gerenciar sys_alerts_cache_triggers.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAlertsCacheTriggers, as: Schema
  
  @resource_name "sys_alerts_cache_trigger"
