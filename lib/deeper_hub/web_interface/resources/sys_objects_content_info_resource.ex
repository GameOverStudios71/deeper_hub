defmodule DeeperHub.WebInterface.Resources.SysObjectsContentInfoResource do
  @moduledoc """
  Recurso REST para sys_objects_content_infos.
  Fornece endpoints para gerenciar sys_objects_content_infos.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsContentInfo, as: Schema
  
  @resource_name "sys_objects_content_info"
