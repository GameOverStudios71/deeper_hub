defmodule DeeperHub.WebInterface.Resources.SysPagesBlocksDataResource do
  @moduledoc """
  Recurso REST para sys_pages_blocks_datas.
  Fornece endpoints para gerenciar sys_pages_blocks_datas.
  ...
  alias DeeperHub.Core.Data.Schemas.SysPagesBlocksData, as: Schema
  
  @resource_name "sys_pages_blocks_data"
