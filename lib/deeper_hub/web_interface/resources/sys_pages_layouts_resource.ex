defmodule DeeperHub.WebInterface.Resources.SysPagesLayoutsResource do
  @moduledoc """
  Recurso REST para sys_pages_layouts.
  Fornece endpoints para gerenciar sys_pages_layouts.
  ...
  alias DeeperHub.Core.Data.Schemas.SysPagesLayouts, as: Schema
  
  @resource_name "sys_pages_layout"
