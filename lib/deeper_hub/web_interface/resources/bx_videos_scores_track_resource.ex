defmodule DeeperHub.WebInterface.Resources.BxVideosScoresTrackResource do
  @moduledoc """
  Recurso REST para bx_videos_scores_tracks.
  Fornece endpoints para gerenciar bx_videos_scores_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.BxVideosScoresTrack, as: Schema
  
  @resource_name "bx_videos_scores_track"
