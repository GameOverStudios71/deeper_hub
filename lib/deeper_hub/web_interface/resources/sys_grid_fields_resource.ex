defmodule DeeperHub.WebInterface.Resources.SysGridFieldsResource do
  @moduledoc """
  Recurso REST para sys_grid_fields.
  Fornece endpoints para gerenciar sys_grid_fields.
  ...
  alias DeeperHub.Core.Data.Schemas.SysGridFields, as: Schema
  
  @resource_name "sys_grid_field"
