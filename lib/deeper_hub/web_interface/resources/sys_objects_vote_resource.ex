defmodule DeeperHub.WebInterface.Resources.SysObjectsVoteResource do
  @moduledoc """
  Recurso REST para sys_objects_votes.
  Fornece endpoints para gerenciar sys_objects_votes.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsVote, as: Schema
  
  @resource_name "sys_objects_vote"
