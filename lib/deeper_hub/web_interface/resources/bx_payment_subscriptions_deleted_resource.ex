defmodule DeeperHub.WebInterface.Resources.BxPaymentSubscriptionsDeletedResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxPaymentSubscriptionsDeleted, as: Schema
