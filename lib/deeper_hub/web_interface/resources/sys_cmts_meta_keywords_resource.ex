defmodule DeeperHub.WebInterface.Resources.SysCmtsMetaKeywordsResource do
  @moduledoc """
  Recurso REST para sys_cmts_meta_keywords.
  Fornece endpoints para gerenciar sys_cmts_meta_keywords.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCmtsMetaKeywords, as: Schema
  
  @resource_name "sys_cmts_meta_keyword"
