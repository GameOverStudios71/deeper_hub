defmodule DeeperHub.WebInterface.Resources.SysObjectsGridResource do
  @moduledoc """
  Recurso REST para sys_objects_grids.
  Fornece endpoints para gerenciar sys_objects_grids.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsGrid, as: Schema
  
  @resource_name "sys_objects_grid"
