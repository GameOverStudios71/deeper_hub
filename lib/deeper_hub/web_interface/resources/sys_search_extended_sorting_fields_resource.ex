defmodule DeeperHub.WebInterface.Resources.SysSearchExtendedSortingFieldsResource do
  @moduledoc """
  Recurso REST para sys_search_extended_sorting_fields.
  Fornece endpoints para gerenciar sys_search_extended_sorting_fields.
  ...
  alias DeeperHub.Core.Data.Schemas.SysSearchExtendedSortingFields, as: Schema
  
  @resource_name "sys_search_extended_sorting_field"
