defmodule DeeperHub.WebInterface.Resources.SysCmtsImagesResource do
  @moduledoc """
  Recurso REST para sys_cmts_images.
  Fornece endpoints para gerenciar sys_cmts_images.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCmtsImages, as: Schema
  
  @resource_name "sys_cmts_image"
