defmodule DeeperHub.WebInterface.Resources.SysStatisticsResource do
  @moduledoc """
  Recurso REST para sys_statistics.
  Fornece endpoints para gerenciar sys_statistics.
  ...
  alias DeeperHub.Core.Data.Schemas.SysStatistics, as: Schema
  
  @resource_name "sys_statistic"
