defmodule DeeperHub.WebInterface.Resources.SysFormDisplayInputsResource do
  @moduledoc """
  Recurso REST para sys_form_display_inputs.
  Fornece endpoints para gerenciar sys_form_display_inputs.
  ...
  alias DeeperHub.Core.Data.Schemas.SysFormDisplayInputs, as: Schema
  
  @resource_name "sys_form_display_input"
