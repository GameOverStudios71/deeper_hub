defmodule DeeperHub.WebInterface.Resources.BxVideosVotesResource do
  @moduledoc """
  Recurso REST para bx_videos_votes.
  Fornece endpoints para gerenciar bx_videos_votes.
  ...
  alias DeeperHub.Core.Data.Schemas.BxVideosVotes, as: Schema
  
  @resource_name "bx_videos_vote"
