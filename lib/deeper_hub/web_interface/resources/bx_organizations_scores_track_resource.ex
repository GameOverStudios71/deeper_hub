defmodule DeeperHub.WebInterface.Resources.BxOrganizationsScoresTrackResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxOrganizationsScoresTrack, as: Schema
