defmodule DeeperHub.WebInterface.Resources.SysCmtsMetaMentionsResource do
  @moduledoc """
  Recurso REST para sys_cmts_meta_mentions.
  Fornece endpoints para gerenciar sys_cmts_meta_mentions.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCmtsMetaMentions, as: Schema
  
  @resource_name "sys_cmts_meta_mention"
