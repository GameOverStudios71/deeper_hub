defmodule DeeperHub.WebInterface.Resources.SysContentInfoGridsResource do
  @moduledoc """
  Recurso REST para sys_content_info_grids.
  Fornece endpoints para gerenciar sys_content_info_grids.
  ...
  alias DeeperHub.Core.Data.Schemas.SysContentInfoGrids, as: Schema
  
  @resource_name "sys_content_info_grid"
