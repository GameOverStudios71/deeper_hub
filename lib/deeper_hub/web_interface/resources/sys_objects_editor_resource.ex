defmodule DeeperHub.WebInterface.Resources.SysObjectsEditorResource do
  @moduledoc """
  Recurso REST para sys_objects_editors.
  Fornece endpoints para gerenciar sys_objects_editors.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsEditor, as: Schema
  
  @resource_name "sys_objects_editor"
