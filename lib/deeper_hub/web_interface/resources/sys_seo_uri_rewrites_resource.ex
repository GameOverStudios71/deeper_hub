defmodule DeeperHub.WebInterface.Resources.SysSeoUriRewritesResource do
  @moduledoc """
  Recurso REST para sys_seo_uri_rewrites.
  Fornece endpoints para gerenciar sys_seo_uri_rewrites.
  ...
  alias DeeperHub.Core.Data.Schemas.SysSeoUriRewrites, as: Schema
  
  @resource_name "sys_seo_uri_rewrite"
