defmodule DeeperHub.WebInterface.Resources.SysFormInputsPrivacyResource do
  @moduledoc """
  Recurso REST para sys_form_inputs_privacys.
  Fornece endpoints para gerenciar sys_form_inputs_privacys.
  ...
  alias DeeperHub.Core.Data.Schemas.SysFormInputsPrivacy, as: Schema
  
  @resource_name "sys_form_inputs_privacy"
