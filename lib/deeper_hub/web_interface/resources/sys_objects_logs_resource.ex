defmodule DeeperHub.WebInterface.Resources.SysObjectsLogsResource do
  @moduledoc """
  Recurso REST para sys_objects_logs.
  Fornece endpoints para gerenciar sys_objects_logs.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsLogs, as: Schema
  
  @resource_name "sys_objects_log"
