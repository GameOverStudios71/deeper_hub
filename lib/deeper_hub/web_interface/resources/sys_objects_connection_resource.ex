defmodule DeeperHub.WebInterface.Resources.SysObjectsConnectionResource do
  @moduledoc """
  Recurso REST para sys_objects_connections.
  Fornece endpoints para gerenciar sys_objects_connections.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsConnection, as: Schema
  
  @resource_name "sys_objects_connection"
