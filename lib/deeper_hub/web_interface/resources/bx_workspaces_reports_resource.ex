defmodule DeeperHub.WebInterface.Resources.BxWorkspacesReportsResource do
  @moduledoc """
  Recurso REST para bx_workspaces_reports.
  Fornece endpoints para gerenciar bx_workspaces_reports.
  ...
  alias DeeperHub.Core.Data.Schemas.BxWorkspacesReports, as: Schema
  
  @resource_name "bx_workspaces_report"
