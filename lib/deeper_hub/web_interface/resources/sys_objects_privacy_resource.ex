defmodule DeeperHub.WebInterface.Resources.SysObjectsPrivacyResource do
  @moduledoc """
  Recurso REST para sys_objects_privacys.
  Fornece endpoints para gerenciar sys_objects_privacys.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsPrivacy, as: Schema
  
  @resource_name "sys_objects_privacy"
