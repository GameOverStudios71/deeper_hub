defmodule DeeperHub.WebInterface.Resources.BxPaymentStripePaymentsPendingResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxPaymentStripePaymentsPending, as: Schema
