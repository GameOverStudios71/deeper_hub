defmodule DeeperHub.WebInterface.Resources.SysObjectsAuthsResource do
  @moduledoc """
  Recurso REST para sys_objects_auths.
  Fornece endpoints para gerenciar sys_objects_auths.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsAuths, as: Schema
  
  @resource_name "sys_objects_auth"
