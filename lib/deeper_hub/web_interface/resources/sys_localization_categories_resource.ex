defmodule DeeperHub.WebInterface.Resources.SysLocalizationCategoriesResource do
  @moduledoc """
  Recurso REST para sys_localization_categories.
  Fornece endpoints para gerenciar sys_localization_categories.
  ...
  alias DeeperHub.Core.Data.Schemas.SysLocalizationCategories, as: Schema
  
  @resource_name "sys_localization_categorie"
