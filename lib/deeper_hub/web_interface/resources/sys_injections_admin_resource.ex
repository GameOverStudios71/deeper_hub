defmodule DeeperHub.WebInterface.Resources.SysInjectionsAdminResource do
  @moduledoc """
  Recurso REST para sys_injections_admins.
  Fornece endpoints para gerenciar sys_injections_admins.
  ...
  alias DeeperHub.Core.Data.Schemas.SysInjectionsAdmin, as: Schema
  
  @resource_name "sys_injections_admin"
