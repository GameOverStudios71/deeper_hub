defmodule DeeperHub.WebInterface.Resources.SysWikiFilesResource do
  @moduledoc """
  Recurso REST para sys_wiki_files.
  Fornece endpoints para gerenciar sys_wiki_files.
  ...
  alias DeeperHub.Core.Data.Schemas.SysWikiFiles, as: Schema
  
  @resource_name "sys_wiki_file"
