defmodule DeeperHub.WebInterface.Resources.SysModulesFileTracksResource do
  @moduledoc """
  Recurso REST para sys_modules_file_tracks.
  Fornece endpoints para gerenciar sys_modules_file_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.SysModulesFileTracks, as: Schema
  
  @resource_name "sys_modules_file_track"
