defmodule DeeperHub.WebInterface.Resources.SysCronJobsResource do
  @moduledoc """
  Recurso REST para sys_cron_jobs.
  Fornece endpoints para gerenciar sys_cron_jobs.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCronJobs, as: Schema
  
  @resource_name "sys_cron_job"
