defmodule DeeperHub.WebInterface.Resources.BxPostsPollsAnswersVotesTrackResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxPostsPollsAnswersVotesTrack, as: Schema
