defmodule DeeperHub.WebInterface.Resources.BxReviewsPollsAnswersVotesResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxReviewsPollsAnswersVotes, as: Schema
