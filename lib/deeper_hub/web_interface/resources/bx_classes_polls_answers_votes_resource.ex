defmodule DeeperHub.WebInterface.Resources.BxClassesPollsAnswersVotesResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxClassesPollsAnswersVotes, as: Schema
