defmodule DeeperHub.WebInterface.Resources.SysObjectsTranscoderResource do
  @moduledoc """
  Recurso REST para sys_objects_transcoders.
  Fornece endpoints para gerenciar sys_objects_transcoders.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsTranscoder, as: Schema
  
  @resource_name "sys_objects_transcoder"
