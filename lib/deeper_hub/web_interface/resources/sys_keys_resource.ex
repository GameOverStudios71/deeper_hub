defmodule DeeperHub.WebInterface.Resources.SysKeysResource do
  @moduledoc """
  Recurso REST para sys_keys.
  Fornece endpoints para gerenciar sys_keys.
  ...
  alias DeeperHub.Core.Data.Schemas.SysKeys, as: Schema
  
  @resource_name "sys_key"
