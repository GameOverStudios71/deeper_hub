defmodule DeeperHub.WebInterface.Resources.SysObjectsSmsResource do
  @moduledoc """
  Recurso REST para sys_objects_sms.
  Fornece endpoints para gerenciar sys_objects_sms.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsSms, as: Schema
  
  @resource_name "sys_objects_sm"
