defmodule DeeperHub.WebInterface.Resources.BxVideosSvotesTrackResource do
  @moduledoc """
  Recurso REST para bx_videos_svotes_tracks.
  Fornece endpoints para gerenciar bx_videos_svotes_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.BxVideosSvotesTrack, as: Schema
  
  @resource_name "bx_videos_svotes_track"
