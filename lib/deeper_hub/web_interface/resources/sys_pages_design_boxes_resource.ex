defmodule DeeperHub.WebInterface.Resources.SysPagesDesignBoxesResource do
  @moduledoc """
  Recurso REST para sys_pages_design_boxes.
  Fornece endpoints para gerenciar sys_pages_design_boxes.
  ...
  alias DeeperHub.Core.Data.Schemas.SysPagesDesignBoxes, as: Schema
  
  @resource_name "sys_pages_design_boxe"
