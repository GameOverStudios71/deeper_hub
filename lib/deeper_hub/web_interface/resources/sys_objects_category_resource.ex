defmodule DeeperHub.WebInterface.Resources.SysObjectsCategoryResource do
  @moduledoc """
  Recurso REST para sys_objects_categorys.
  Fornece endpoints para gerenciar sys_objects_categorys.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsCategory, as: Schema
  
  @resource_name "sys_objects_category"
