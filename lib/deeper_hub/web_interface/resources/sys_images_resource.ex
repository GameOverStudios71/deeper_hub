defmodule DeeperHub.WebInterface.Resources.SysImagesResource do
  @moduledoc """
  Recurso REST para sys_images.
  Fornece endpoints para gerenciar sys_images.
  ...
  alias DeeperHub.Core.Data.Schemas.SysImages, as: Schema
  
  @resource_name "sys_image"
