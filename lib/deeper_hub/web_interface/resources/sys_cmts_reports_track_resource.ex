defmodule DeeperHub.WebInterface.Resources.SysCmtsReportsTrackResource do
  @moduledoc """
  Recurso REST para sys_cmts_reports_tracks.
  Fornece endpoints para gerenciar sys_cmts_reports_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCmtsReportsTrack, as: Schema
  
  @resource_name "sys_cmts_reports_track"
