defmodule DeeperHub.WebInterface.Resources.SysModulesRelationsResource do
  @moduledoc """
  Recurso REST para sys_modules_relations.
  Fornece endpoints para gerenciar sys_modules_relations.
  ...
  alias DeeperHub.Core.Data.Schemas.SysModulesRelations, as: Schema
  
  @resource_name "sys_modules_relation"
