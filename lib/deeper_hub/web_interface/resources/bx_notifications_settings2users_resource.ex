defmodule DeeperHub.WebInterface.Resources.BxNotificationsSettings2usersResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxNotificationsSettings2users, as: Schema
