defmodule DeeperHub.WebInterface.Resources.BxWorkspacesScoresTrackResource do
  @moduledoc """
  Recurso REST para bx_workspaces_scores_tracks.
  Fornece endpoints para gerenciar bx_workspaces_scores_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.BxWorkspacesScoresTrack, as: Schema
  
  @resource_name "bx_workspaces_scores_track"
