defmodule DeeperHub.WebInterface.Resources.SysWikiImagesResizedResource do
  @moduledoc """
  Recurso REST para sys_wiki_images_resizeds.
  Fornece endpoints para gerenciar sys_wiki_images_resizeds.
  ...
  alias DeeperHub.Core.Data.Schemas.SysWikiImagesResized, as: Schema
  
  @resource_name "sys_wiki_images_resized"
