defmodule DeeperHub.WebInterface.Resources.SysApiKeysResource do
  @moduledoc """
  Recurso REST para sys_api_keys.
  Fornece endpoints para gerenciar sys_api_keys.
  ...
  alias DeeperHub.Core.Data.Schemas.SysApiKeys, as: Schema
  
  @resource_name "sys_api_key"
