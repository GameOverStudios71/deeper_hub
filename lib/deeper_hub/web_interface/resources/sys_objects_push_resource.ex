defmodule DeeperHub.WebInterface.Resources.SysObjectsPushResource do
  @moduledoc """
  Recurso REST para sys_objects_pushs.
  Fornece endpoints para gerenciar sys_objects_pushs.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsPush, as: Schema
  
  @resource_name "sys_objects_push"
