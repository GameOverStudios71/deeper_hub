defmodule DeeperHub.WebInterface.Resources.SysObjectsPageResource do
  @moduledoc """
  Recurso REST para sys_objects_pages.
  Fornece endpoints para gerenciar sys_objects_pages.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsPage, as: Schema
  
  @resource_name "sys_objects_page"
