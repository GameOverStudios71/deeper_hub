defmodule DeeperHub.WebInterface.Resources.SysGridActionsResource do
  @moduledoc """
  Recurso REST para sys_grid_actions.
  Fornece endpoints para gerenciar sys_grid_actions.
  ...
  alias DeeperHub.Core.Data.Schemas.SysGridActions, as: Schema
  
  @resource_name "sys_grid_action"
