defmodule DeeperHub.WebInterface.Resources.BxReputationProfilesLevelsResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxReputationProfilesLevels, as: Schema
