defmodule DeeperHub.WebInterface.Resources.SysObjectsSearchResource do
  @moduledoc """
  Recurso REST para sys_objects_searchs.
  Fornece endpoints para gerenciar sys_objects_searchs.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsSearch, as: Schema
  
  @resource_name "sys_objects_search"
