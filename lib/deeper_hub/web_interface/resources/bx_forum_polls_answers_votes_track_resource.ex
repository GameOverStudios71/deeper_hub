defmodule DeeperHub.WebInterface.Resources.BxForumPollsAnswersVotesTrackResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxForumPollsAnswersVotesTrack, as: Schema
