defmodule DeeperHub.WebInterface.Resources.SysMenuItemsResource do
  @moduledoc """
  Recurso REST para sys_menu_items.
  Fornece endpoints para gerenciar sys_menu_items.
  ...
  alias DeeperHub.Core.Data.Schemas.SysMenuItems, as: Schema
  
  @resource_name "sys_menu_item"
