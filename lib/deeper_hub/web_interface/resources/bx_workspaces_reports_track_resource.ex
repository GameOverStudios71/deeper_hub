defmodule DeeperHub.WebInterface.Resources.BxWorkspacesReportsTrackResource do
  @moduledoc """
  Recurso REST para bx_workspaces_reports_tracks.
  Fornece endpoints para gerenciar bx_workspaces_reports_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.BxWorkspacesReportsTrack, as: Schema
  
  @resource_name "bx_workspaces_reports_track"
