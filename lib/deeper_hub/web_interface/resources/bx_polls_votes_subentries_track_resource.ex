defmodule DeeperHub.WebInterface.Resources.BxPollsVotesSubentriesTrackResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxPollsVotesSubentriesTrack, as: Schema
