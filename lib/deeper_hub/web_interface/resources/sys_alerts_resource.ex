defmodule DeeperHub.WebInterface.Resources.SysAlertsResource do
  @moduledoc """
  Recurso REST para sys_alerts.
  Fornece endpoints para gerenciar sys_alerts.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAlerts, as: Schema
  
  @resource_name "sys_alert"
