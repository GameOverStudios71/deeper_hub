defmodule DeeperHub.WebInterface.Resources.SysObjectsRecommendationResource do
  @moduledoc """
  Recurso REST para sys_objects_recommendations.
  Fornece endpoints para gerenciar sys_objects_recommendations.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsRecommendation, as: Schema
  
  @resource_name "sys_objects_recommendation"
