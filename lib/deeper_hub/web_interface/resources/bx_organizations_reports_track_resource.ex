defmodule DeeperHub.WebInterface.Resources.BxOrganizationsReportsTrackResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxOrganizationsReportsTrack, as: Schema
