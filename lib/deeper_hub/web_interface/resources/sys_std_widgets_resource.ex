defmodule DeeperHub.WebInterface.Resources.SysStdWidgetsResource do
  @moduledoc """
  Recurso REST para sys_std_widgets.
  Fornece endpoints para gerenciar sys_std_widgets.
  ...
  alias DeeperHub.Core.Data.Schemas.SysStdWidgets, as: Schema
  
  @resource_name "sys_std_widget"
