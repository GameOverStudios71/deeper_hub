defmodule DeeperHub.WebInterface.Resources.BxPhotosMetaKeywordsCameraResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxPhotosMetaKeywordsCamera, as: Schema
