defmodule DeeperHub.WebInterface.Resources.SysStdRolesResource do
  @moduledoc """
  Recurso REST para sys_std_roles.
  Fornece endpoints para gerenciar sys_std_roles.
  ...
  alias DeeperHub.Core.Data.Schemas.SysStdRoles, as: Schema
  
  @resource_name "sys_std_role"
