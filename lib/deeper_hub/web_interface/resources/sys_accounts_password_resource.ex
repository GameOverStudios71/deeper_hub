defmodule DeeperHub.WebInterface.Resources.SysAccountsPasswordResource do
  @moduledoc """
  Recurso REST para sys_accounts_passwords.
  Fornece endpoints para gerenciar sys_accounts_passwords.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAccountsPassword, as: Schema
  
  @resource_name "sys_accounts_password"
