defmodule DeeperHub.WebInterface.Resources.SysQueuePushResource do
  @moduledoc """
  Recurso REST para sys_queue_pushs.
  Fornece endpoints para gerenciar sys_queue_pushs.
  ...
  alias DeeperHub.Core.Data.Schemas.SysQueuePush, as: Schema
  
  @resource_name "sys_queue_push"
