defmodule DeeperHub.WebInterface.Resources.SysAgentsAssistantsChatsMessagesResource do
  @moduledoc """
  Recurso REST para sys_agents_assistants_chats_messages.
  Fornece endpoints para gerenciar sys_agents_assistants_chats_messages.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsAssistantsChatsMessages, as: Schema
  
  @resource_name "sys_agents_assistants_chats_message"
