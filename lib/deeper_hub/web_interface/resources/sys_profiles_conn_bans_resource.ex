defmodule DeeperHub.WebInterface.Resources.SysProfilesConnBansResource do
  @moduledoc """
  Recurso REST para sys_profiles_conn_bans.
  Fornece endpoints para gerenciar sys_profiles_conn_bans.
  ...
  alias DeeperHub.Core.Data.Schemas.SysProfilesConnBans, as: Schema
  
  @resource_name "sys_profiles_conn_ban"
