defmodule DeeperHub.WebInterface.Resources.SysSessionsResource do
  @moduledoc """
  Recurso REST para sys_sessions.
  Fornece endpoints para gerenciar sys_sessions.
  ...
  alias DeeperHub.Core.Data.Schemas.SysSessions, as: Schema
  
  @resource_name "sys_session"
