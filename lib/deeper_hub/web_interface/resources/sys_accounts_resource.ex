defmodule DeeperHub.WebInterface.Resources.SysAccountsResource do
  @moduledoc """
  Recurso REST para sys_accounts.
  Fornece endpoints para gerenciar sys_accounts.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAccounts, as: Schema
  
  @resource_name "sys_account"
