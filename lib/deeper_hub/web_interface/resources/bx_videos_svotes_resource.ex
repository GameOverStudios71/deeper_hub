defmodule DeeperHub.WebInterface.Resources.BxVideosSvotesResource do
  @moduledoc """
  Recurso REST para bx_videos_svotes.
  Fornece endpoints para gerenciar bx_videos_svotes.
  ...
  alias DeeperHub.Core.Data.Schemas.BxVideosSvotes, as: Schema
  
  @resource_name "bx_videos_svote"
