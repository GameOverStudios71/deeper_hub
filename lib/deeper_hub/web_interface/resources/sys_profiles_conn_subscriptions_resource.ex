defmodule DeeperHub.WebInterface.Resources.SysProfilesConnSubscriptionsResource do
  @moduledoc """
  Recurso REST para sys_profiles_conn_subscriptions.
  Fornece endpoints para gerenciar sys_profiles_conn_subscriptions.
  ...
  alias DeeperHub.Core.Data.Schemas.SysProfilesConnSubscriptions, as: Schema
  
  @resource_name "sys_profiles_conn_subscription"
