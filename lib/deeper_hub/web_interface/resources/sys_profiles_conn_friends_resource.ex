defmodule DeeperHub.WebInterface.Resources.SysProfilesConnFriendsResource do
  @moduledoc """
  Recurso REST para sys_profiles_conn_friends.
  Fornece endpoints para gerenciar sys_profiles_conn_friends.
  ...
  alias DeeperHub.Core.Data.Schemas.SysProfilesConnFriends, as: Schema
  
  @resource_name "sys_profiles_conn_friend"
