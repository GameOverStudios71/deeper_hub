defmodule DeeperHub.WebInterface.Resources.SysImagesResizedResource do
  @moduledoc """
  Recurso REST para sys_images_resizeds.
  Fornece endpoints para gerenciar sys_images_resizeds.
  ...
  alias DeeperHub.Core.Data.Schemas.SysImagesResized, as: Schema
  
  @resource_name "sys_images_resized"
