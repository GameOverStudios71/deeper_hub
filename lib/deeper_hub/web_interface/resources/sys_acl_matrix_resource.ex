defmodule DeeperHub.WebInterface.Resources.SysAclMatrixResource do
  @moduledoc """
  Recurso REST para sys_acl_matrixs.
  Fornece endpoints para gerenciar sys_acl_matrixs.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAclMatrix, as: Schema
  
  @resource_name "sys_acl_matrix"
