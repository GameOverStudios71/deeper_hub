defmodule DeeperHub.WebInterface.Resources.BxTimelinePollsAnswersVotesResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxTimelinePollsAnswersVotes, as: Schema
