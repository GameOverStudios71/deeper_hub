defmodule DeeperHub.WebInterface.Resources.SysAgentsAutomatorsProvidersResource do
  @moduledoc """
  Recurso REST para sys_agents_automators_providers.
  Fornece endpoints para gerenciar sys_agents_automators_providers.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsAutomatorsProviders, as: Schema
  
  @resource_name "sys_agents_automators_provider"
