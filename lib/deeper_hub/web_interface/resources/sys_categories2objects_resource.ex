defmodule DeeperHub.WebInterface.Resources.SysCategories2objectsResource do
  @moduledoc """
  Recurso REST para sys_categories2objects.
  Fornece endpoints para gerenciar sys_categories2objects.
  ...
  alias DeeperHub.Core.Data.Schemas.SysCategories2objects, as: Schema
  
  @resource_name "sys_categories2object"
