defmodule DeeperHub.WebInterface.Resources.BxAlbumsFavoritesMediaTrackResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxAlbumsFavoritesMediaTrack, as: Schema
