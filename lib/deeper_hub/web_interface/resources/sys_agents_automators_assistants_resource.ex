defmodule DeeperHub.WebInterface.Resources.SysAgentsAutomatorsAssistantsResource do
  @moduledoc """
  Recurso REST para sys_agents_automators_assistants.
  Fornece endpoints para gerenciar sys_agents_automators_assistants.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAgentsAutomatorsAssistants, as: Schema
  
  @resource_name "sys_agents_automators_assistant"
