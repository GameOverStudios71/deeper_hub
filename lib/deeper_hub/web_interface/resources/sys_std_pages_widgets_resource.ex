defmodule DeeperHub.WebInterface.Resources.SysStdPagesWidgetsResource do
  @moduledoc """
  Recurso REST para sys_std_pages_widgets.
  Fornece endpoints para gerenciar sys_std_pages_widgets.
  ...
  alias DeeperHub.Core.Data.Schemas.SysStdPagesWidgets, as: Schema
  
  @resource_name "sys_std_pages_widget"
