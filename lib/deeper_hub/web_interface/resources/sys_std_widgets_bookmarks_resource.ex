defmodule DeeperHub.WebInterface.Resources.SysStdWidgetsBookmarksResource do
  @moduledoc """
  Recurso REST para sys_std_widgets_bookmarks.
  Fornece endpoints para gerenciar sys_std_widgets_bookmarks.
  ...
  alias DeeperHub.Core.Data.Schemas.SysStdWidgetsBookmarks, as: Schema
  
  @resource_name "sys_std_widgets_bookmark"
