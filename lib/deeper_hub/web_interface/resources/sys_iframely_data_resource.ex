defmodule DeeperHub.WebInterface.Resources.SysIframelyDataResource do
  @moduledoc """
  Recurso REST para sys_iframely_datas.
  Fornece endpoints para gerenciar sys_iframely_datas.
  ...
  alias DeeperHub.Core.Data.Schemas.SysIframelyData, as: Schema
  
  @resource_name "sys_iframely_data"
