defmodule DeeperHub.WebInterface.Resources.SysStorageMimeTypesResource do
  @moduledoc """
  Recurso REST para sys_storage_mime_types.
  Fornece endpoints para gerenciar sys_storage_mime_types.
  ...
  alias DeeperHub.Core.Data.Schemas.SysStorageMimeTypes, as: Schema
  
  @resource_name "sys_storage_mime_type"
