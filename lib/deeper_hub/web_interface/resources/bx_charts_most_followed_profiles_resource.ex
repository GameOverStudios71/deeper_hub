defmodule DeeperHub.WebInterface.Resources.BxChartsMostFollowedProfilesResource do
  @moduledoc """
  Recurso REST para bx_charts_most_followed_profiles.
  Fornece endpoints para gerenciar bx_charts_most_followed_profiles.
  ...
  alias DeeperHub.Core.Data.Schemas.BxChartsMostFollowedProfiles, as: Schema
  
  @resource_name "bx_charts_most_followed_profile"
