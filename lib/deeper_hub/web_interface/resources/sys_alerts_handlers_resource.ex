defmodule DeeperHub.WebInterface.Resources.SysAlertsHandlersResource do
  @moduledoc """
  Recurso REST para sys_alerts_handlers.
  Fornece endpoints para gerenciar sys_alerts_handlers.
  ...
  alias DeeperHub.Core.Data.Schemas.SysAlertsHandlers, as: Schema
  
  @resource_name "sys_alerts_handler"
