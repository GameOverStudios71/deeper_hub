defmodule DeeperHub.WebInterface.Resources.SysImagesEditorResource do
  @moduledoc """
  Recurso REST para sys_images_editors.
  Fornece endpoints para gerenciar sys_images_editors.
  ...
  alias DeeperHub.Core.Data.Schemas.SysImagesEditor, as: Schema
  
  @resource_name "sys_images_editor"
