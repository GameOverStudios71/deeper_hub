defmodule DeeperHub.WebInterface.Resources.SysFormFieldsReactionTrackResource do
  @moduledoc """
  Recurso REST para sys_form_fields_reaction_tracks.
  Fornece endpoints para gerenciar sys_form_fields_reaction_tracks.
  ...
  alias DeeperHub.Core.Data.Schemas.SysFormFieldsReactionTrack, as: Schema
  
  @resource_name "sys_form_fields_reaction_track"
