defmodule DeeperHub.WebInterface.Resources.SysEmailTemplatesResource do
  @moduledoc """
  Recurso REST para sys_email_templates.
  Fornece endpoints para gerenciar sys_email_templates.
  ...
  alias DeeperHub.Core.Data.Schemas.SysEmailTemplates, as: Schema
  
  @resource_name "sys_email_template"
