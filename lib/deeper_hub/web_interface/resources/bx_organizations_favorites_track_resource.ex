defmodule DeeperHub.WebInterface.Resources.BxOrganizationsFavoritesTrackResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxOrganizationsFavoritesTrack, as: Schema
