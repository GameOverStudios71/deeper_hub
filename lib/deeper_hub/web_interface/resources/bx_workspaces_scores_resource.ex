defmodule DeeperHub.WebInterface.Resources.BxWorkspacesScoresResource do
  @moduledoc """
  Recurso REST para bx_workspaces_scores.
  Fornece endpoints para gerenciar bx_workspaces_scores.
  ...
  alias DeeperHub.Core.Data.Schemas.BxWorkspacesScores, as: Schema
  
  @resource_name "bx_workspaces_score"
