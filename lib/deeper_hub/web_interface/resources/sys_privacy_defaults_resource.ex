defmodule DeeperHub.WebInterface.Resources.SysPrivacyDefaultsResource do
  @moduledoc """
  Recurso REST para sys_privacy_defaults.
  Fornece endpoints para gerenciar sys_privacy_defaults.
  ...
  alias DeeperHub.Core.Data.Schemas.SysPrivacyDefaults, as: Schema
  
  @resource_name "sys_privacy_default"
