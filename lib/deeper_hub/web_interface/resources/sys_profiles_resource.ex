defmodule DeeperHub.WebInterface.Resources.SysProfilesResource do
  @moduledoc """
  Recurso REST para sys_profiles.
  Fornece endpoints para gerenciar sys_profiles.
  ...
  alias DeeperHub.Core.Data.Schemas.SysProfiles, as: Schema
  
  @resource_name "sys_profile"
