defmodule DeeperHub.WebInterface.Resources.SysObjectsLiveUpdatesResource do
  @moduledoc """
  Recurso REST para sys_objects_live_updates.
  Fornece endpoints para gerenciar sys_objects_live_updates.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsLiveUpdates, as: Schema
  
  @resource_name "sys_objects_live_update"
