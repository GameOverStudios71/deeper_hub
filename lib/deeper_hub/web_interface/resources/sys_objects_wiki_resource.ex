defmodule DeeperHub.WebInterface.Resources.SysObjectsWikiResource do
  @moduledoc """
  Recurso REST para sys_objects_wikis.
  Fornece endpoints para gerenciar sys_objects_wikis.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsWiki, as: Schema
  
  @resource_name "sys_objects_wiki"
