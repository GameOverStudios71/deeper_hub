defmodule DeeperHub.WebInterface.Resources.SysInjectionsResource do
  @moduledoc """
  Recurso REST para sys_injections.
  Fornece endpoints para gerenciar sys_injections.
  ...
  alias DeeperHub.Core.Data.Schemas.SysInjections, as: Schema
  
  @resource_name "sys_injection"
