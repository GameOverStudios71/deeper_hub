defmodule DeeperHub.WebInterface.Resources.SysObjectsSearchExtendedResource do
  @moduledoc """
  Recurso REST para sys_objects_search_extendeds.
  Fornece endpoints para gerenciar sys_objects_search_extendeds.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsSearchExtended, as: Schema
  
  @resource_name "sys_objects_search_extended"
