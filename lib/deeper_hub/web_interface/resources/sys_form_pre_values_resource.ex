defmodule DeeperHub.WebInterface.Resources.SysFormPreValuesResource do
  @moduledoc """
  Recurso REST para sys_form_pre_values.
  Fornece endpoints para gerenciar sys_form_pre_values.
  ...
  alias DeeperHub.Core.Data.Schemas.SysFormPreValues, as: Schema
  
  @resource_name "sys_form_pre_value"
