defmodule DeeperHub.WebInterface.Resources.SysObjectsPlayerResource do
  @moduledoc """
  Recurso REST para sys_objects_players.
  Fornece endpoints para gerenciar sys_objects_players.
  ...
  alias DeeperHub.Core.Data.Schemas.SysObjectsPlayer, as: Schema
  
  @resource_name "sys_objects_player"
