defmodule DeeperHub.WebInterface.Resources.SysRewriteRulesResource do
  @moduledoc """
  Recurso REST para sys_rewrite_rules.
  Fornece endpoints para gerenciar sys_rewrite_rules.
  ...
  alias DeeperHub.Core.Data.Schemas.SysRewriteRules, as: Schema
  
  @resource_name "sys_rewrite_rule"
