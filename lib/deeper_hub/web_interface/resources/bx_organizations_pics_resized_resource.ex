defmodule DeeperHub.WebInterface.Resources.BxOrganizationsPicsResizedResource do
  @moduledoc """
  ...
  alias DeeperHub.Core.Data.Schemas.BxOrganizationsPicsResized, as: Schema
