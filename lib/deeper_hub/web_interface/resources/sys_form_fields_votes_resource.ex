defmodule DeeperHub.WebInterface.Resources.SysFormFieldsVotesResource do
  @moduledoc """
  Recurso REST para sys_form_fields_votes.
  Fornece endpoints para gerenciar sys_form_fields_votes.
  ...
  alias DeeperHub.Core.Data.Schemas.SysFormFieldsVotes, as: Schema
  
  @resource_name "sys_form_fields_vote"
