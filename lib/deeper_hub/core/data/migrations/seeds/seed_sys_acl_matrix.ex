defmodule DeeperHub.Core.Data.Migrations.Seeds.SysAclMatrixSeed do
  ...
  """
  def run do
    Logger.info("Inserindo registros na tabela sys_acl_matrix...", module: __MODULE__)
    ...
    Repo.execute("INSERT OR REPLACE INTO sys_acl_matrix (IDLevel, IDAction, AllowedCount, AllowedPeriodLen, AllowedPeriodStart, AllowedPeriodEnd, AdditionalParamValue) VALUES (?, ?, ?, ?, ?, ?, ?)", [8, 43, nil, nil, nil, nil, nil])
      Logger.info("Registros inseridos com sucesso na tabela sys_acl_matrix!", module: __MODULE__)
    rescue
      error ->
        Logger.error("Erro ao inserir registros na tabela sys_acl_matrix: #{inspect(error)}", module: __MODULE__)
