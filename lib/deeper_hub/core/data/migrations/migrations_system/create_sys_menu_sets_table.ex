defmodule DeeperHub.Core.Data.Migrations.CreateSysMenuSetsTable do
  @moduledoc """
  Migração para criar a tabela sys_menu_sets no banco de dados.

  Esta migração cria a estrutura básica para armazenar informações de conjuntos de menu
  ...
  def up do
    ...
    CREATE INDEX IF NOT EXISTS idx_sys_menu_sets_module_name ON sys_menu_sets(module_name);
    CREATE INDEX IF NOT EXISTS idx_sys_menu_sets_set_name ON sys_menu_sets(set_name);
    """
