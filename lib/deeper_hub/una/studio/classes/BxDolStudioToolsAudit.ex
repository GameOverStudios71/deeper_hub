...
defmodule DeeperHub.Inc.Classes.BxDolStudioToolsAudit do
  ...
  ## Retorno
    - any
  """
  def bx_sys_adm_audit_test_email(%{}) do
    # TODO: Implementacao futura
        # 
    #             function bx_sys_adm_audit_test_email()
    #             {
  ...
  ## Retorno
    - any
  """
  def bx_sys_adm_audit_phpinfo(%{}) do
    # TODO: Implementacao futura
        # 
    # 
    #             function bx_sys_adm_audit_phpinfo()
  ...
  ## Parametros
    - sType=BX_DOL_AUDIT_FAIL,sFunc='requirementsPHP'

  ## Retorno
    - any
  """
  def checkRequirements(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - bEcho=true,&aOutputMessages=null

  ## Retorno
    - any
  """
  def requirementsPHP(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sModule,sNameCompiledName=''

  ## Retorno
    - any
  """
  def checkApacheModule(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def getUrlForGooglePageSpeed(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sName,sValue='',sMsg='',bWrapAsListItem=true
