...
defmodule DeeperHub.Inc.Classes.BxDolStudioUtils do
  ...
  ## Parametros
    - mixedModule,sType='menu',bReturnAsUrl=true
  ...
  ## Parametros
    - mixedModule,sName,bReturnAsUrl=true

  ## Retorno
    - any
  """
  def getModuleImage(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sVisibleFor,aVisibleForLevels

  ## Retorno
    - any
  """
  def getVisibilityValue(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iValue,&aValuesAll,&aValuesSelected

  ## Retorno
    - any
  """
  def getVisibilityValues(%{}) do
    # TODO: Implementacao futura
