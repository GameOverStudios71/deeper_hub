...
defmodule DeeperHub.Inc.Classes.BxBaseModGroupsAlertsResponse do
  ...
  ## Parametros
    - oAlert,iInvited,iInviter=0

  ## Retorno
    - any
  """
  def sendMailInvitation(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - oAlert,iProfileId,iSender=0

  ## Retorno
    - any
  """
  def sendMailJoinRequest(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def sendMailJoinRequestAccepted(%{}) do
    # TODO: Implementacao futura
