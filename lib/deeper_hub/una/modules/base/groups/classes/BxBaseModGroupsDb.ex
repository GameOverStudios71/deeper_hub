...
defmodule DeeperHub.Inc.Classes.BxBaseModGroupsDb do
  ...
  ## Retorno
    - any
  """
  def deleteAdminsByProfileId(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iGroupProfileId,iProfileId,bRoleOnly=false
  ...
  ## Parametros
    - iGroupProfileId,iStart=0,iLimit=0
  ...
  ## Parametros
    - iGroupProfileId,iProfileId,mixedRole,mixedPeriod=false,sOrder=''
  ...
  ## Parametros
    - sKey,sGroupProfileId,iAuthorProfileId,iInvitedProfileId
  ...
  ## Parametros
    - iInvitedProfileId,iGroupProfileId

  ## Retorno
    - any
  """
  def getInviteByInvited(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sKey,iGroupProfileId,sColumn,sValue

  ## Retorno
    - any
  """
  def updateInviteByKey(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iQuestionId,iProfileId,sAnswer
