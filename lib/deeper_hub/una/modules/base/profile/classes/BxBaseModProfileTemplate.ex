...
defmodule DeeperHub.Inc.Classes.BxBaseModProfileTemplate do
  ...
  ## Parametros
    - oPage,aData,sTemplateName='cover.html'
  ...
  ## Parametros
    - aData,bSubstituteNoImage=false
  ...
  ## Parametros
    - sSize,aData,bSubstituteNoImage=true

  ## Retorno
    - any
  """
  def _getUnitThumbUrl(%{}) do
    # TODO: Implementacao futura
