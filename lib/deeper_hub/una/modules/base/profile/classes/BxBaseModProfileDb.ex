...
defmodule DeeperHub.Inc.Classes.BxBaseModProfileDb do
  ...
  ## Retorno
    - any
  """
  def getContentInfoByProfileId(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iFileId,sFieldPicture

  ## Retorno
    - any
  """
  def resetContentPictureByFileId(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iContentId,iProfileId,iPictureId,sFieldPicture

  ## Retorno
    - any
  """
  def updateContentPictureById(%{}) do
    # TODO: Implementacao futura
