...
defmodule DeeperHub.Inc.Classes.BxBaseModGeneralFormsEntryHelper do
  ...
  ## Parametros
    - iContentId,aValues,sDisplay=false
  ...
  ## Parametros
    - iContentId,sDisplay=false,sCheckFunction=false

  ## Retorno
    - any
  """
  def deleteDataForm(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def prepareCustomRedirectUrl(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sType,mixedData,aParams=[]

  ## Retorno
    - any
  """
  def prepareResponseAPI(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def _getRedirectFromContext(%{}) do
    # TODO: Implementacao futura
