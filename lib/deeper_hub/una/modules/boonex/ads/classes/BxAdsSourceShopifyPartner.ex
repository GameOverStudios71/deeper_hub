...
defmodule DeeperHub.Inc.Classes.BxAdsSourceShopifyPartner do
  @moduledoc """
  Modulo gerado automaticamente a partir do arquivo PHP C://Users//Admin//deeper_hub//una//modules/boonex/ads/classes/BxAdsSourceShopifyPartner.php
  """
  ...
  @doc """
  Funcao correspondente ao metodo PHP makeAuthorization
  ...
  @doc """
  Funcao correspondente ao metodo PHP authorizeApplication
  ...
  @doc """
  Funcao correspondente ao metodo PHP _getAuthorizeUrl

  ## Parametros
    - aScopes,sRedirectUrl,sNonce,bOnlineAccessMode=false

  ## Retorno
    - any
  """
  def _getAuthorizeUrl(%{}) do
    # TODO: Implementacao futura
  ...
  @doc """
  Funcao correspondente ao metodo PHP _callAuthorize
