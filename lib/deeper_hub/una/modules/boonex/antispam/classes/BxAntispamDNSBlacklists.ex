...
defmodule DeeperHub.Inc.Classes.BxAntispamDNSBlacklists do
  ...
  ## Parametros
    - mixedChain,sIp,querymode=BX_DOL_DNSBL_ANYPOSTV_RETFIRST

  ## Retorno
    - any
  """
  def dnsbl_lookup_ip(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sUri,mixedChain=BX_DOL_DNSBL_CHAIN_URIDNS,querymode=BX_DOL_DNSBL_ANYPOSTV_RETFIRST

  ## Retorno
    - any
  """
  def dnsbl_lookup_uri(%{}) do
    # TODO: Implementacao futura
