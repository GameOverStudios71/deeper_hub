...
defmodule DeeperHub.Inc.Classes.BxPaymentProviderStripeConnect do
  ...
  ## Retorno
    - any
  """
  def actionGetSessionRecurring(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def overwriteCheckoutParamsSingle(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sType,iClientId,iSellerId,sItems,aSessionParams=[]

  ## Retorno
    - any
  """
  def createSessionAuthorize(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def createSessionPaymentEmbedded(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sName,fPercentage,bInclusive=false
  ...
  ## Retorno
    - any
  """
  def getVerificationCodeSession(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def checkVerificationCodeSession(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sType,aParams,&aClient,&aCartInfo

  ## Retorno
    - any
  """
  def _createSession(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sSetupIntentId,fAmount,sCurrency,bConfirm=true

  ## Retorno
    - any
  """
  def _createPaymentIntent(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def _getVerificationCodeSession(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def _checkVerificationCodeSession(%{}) do
    # TODO: Implementacao futura
