...
defmodule DeeperHub.Inc.Classes.BxPaymentProviderPayPal do
  ...
  ## Parametros
    - iPendingId,aCartInfo,bRecurring=false,iRecurringDays=0
  ...
  ## Parametros
    - sConnectionUrl,sRequest

  ## Retorno
    - any
  """
  def _readValidationData(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sCurrencyCode,&aResultData

  ## Retorno
    - any
  """
  def _getReceivedAmount(%{}) do
    # TODO: Implementacao futura
