...
defmodule DeeperHub.Inc.Classes.BxPaymentModule do
  ...
  ## Retorno
    - any
  """
  def actionGetFilterValuesItem(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceGetModulesWithPayments(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceIsAcceptingPayments(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceIsPaymentProvider(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceGetPaymentProvider(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceIsProviderOptions(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceGetProviderOptions(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceGetOptionsDefaultCurrencyCode(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceGetOptionsPersonalCurrencyCode(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceGetOptionsSiteAdmin(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceGetBlockCheckoutOffline(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iSellerId,iModuleId,iItemId,iItemCount,sCustom=''

  ## Retorno
    - any
  """
  def actionAddToCart(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iSellerId,iModuleId,iItemId

  ## Retorno
    - any
  """
  def actionDeleteFromCart(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def actionSubscriptionGetDetails(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def actionSubscriptionChangeDetails(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def actionSubscriptionGetBilling(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def actionSubscriptionChangeBilling(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def actionSubscriptionCancelation(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iId,mixedGridObject=false

  ## Retorno
    - any
  """
  def actionSubscriptionCancel(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def actionAuthorizeCheckout(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def actionCaptureAuthorizedCheckout(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def actionInitializeCheckout(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def actionInitializeCheckoutJson(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sType,iSellerId,sProvider,aItems=[],sRedirect=''

  ## Retorno
    - any
  """
  def serviceAuthorizeCheckout(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sType,sOrderAuth,sRedirect=''

  ## Retorno
    - any
  """
  def serviceCaptureAuthorizedCheckout(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sType,iSellerId,sProvider,aItems=[],sRedirect='',aCustoms=[]

  ## Retorno
    - any
  """
  def serviceInitializeCheckoutApi(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sProvider,mixedVendorId=""

  ## Retorno
    - any
  """
  def actionFinalizeCheckout(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sProvider,mixedVendorId="",aData=[]

  ## Retorno
    - any
  """
  def serviceFinalizeCheckout(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def actionFinalizedCheckout(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sProvider,sAction,mixedVendorId=BX_PAYMENT_EMPTY_ID
  ...
  ## Parametros
    - aItem,bPerform=false

  ## Retorno
    - any
  """
  def isAllowedPurchase(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - aPending,bPerform=false

  ## Retorno
    - any
  """
  def isAllowedManage(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def isAllowedManageInvoices(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def onPaymentRegisterBefore(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - aPending,aSubscription,aResult=[]

  ## Retorno
    - any
  """
  def onSubscriptionCreate(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sSubmenu,sSelModule,sSelName

  ## Retorno
    - any
  """
  def setSiteSubmenu(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceStripeV3CreateSessionApi(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - fAmount,sCurrencyFrom,sCurrencyTo,fRate=false

  ## Retorno
    - any
  """
  def serviceConvert(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def updateCurrencyExchangeRates(%{}) do
    # TODO: Implementacao futura
