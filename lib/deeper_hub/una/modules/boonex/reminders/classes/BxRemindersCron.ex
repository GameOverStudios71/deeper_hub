...
defmodule DeeperHub.Inc.Classes.BxRemindersCron do
  ...
  ## Parametros
    - &oProfile,&aProfile,iDays,iNowYear,iNowMonth,iNowDay

  ## Retorno
    - any
  """
  def _checkDateBeginBirthday(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def _checkDateBeginAnniversary(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - &oProfile,sDate,iDays,iNowYear,iNowMonth,iNowDay
  ...
  ## Parametros
    - sDate,iDays,iNowMonth,iNowDay

  ## Retorno
    - any
  """
  def _checkDateBegin(%{}) do
    # TODO: Implementacao futura
