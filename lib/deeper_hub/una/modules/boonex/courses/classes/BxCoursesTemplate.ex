...
defmodule DeeperHub.Inc.Classes.BxCoursesTemplate do
  ...
  ## Retorno
    - any
  """
  def getJoinedEntriesSummary(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - aContentInfo,aParams=[]

  ## Retorno
    - any
  """
  def entryStructureByLevel(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def entryStructureByParentMl1(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def entryStructureByParentMl2(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def entryStructureByParentMl3(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iProfileId,iContentId,aNode,iUsage

  ## Retorno
    - any
  """
  def _entryNodeItems(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iProfileId,iContentId,iNodeId

  ## Retorno
    - any
  """
  def _getNodeStatus(%{}) do
    # TODO: Implementacao futura
