...
defmodule DeeperHub.Inc.Classes.BxAnalyticsModule do
  ...
  ## Parametros
    - sModuleName,sReportName,sDateFrom,sDateTo,sType=''
  ...
  ## Parametros
    - sModuleName,sReportName,sDateFrom,sDateTo

  ## Retorno
    - any
  """
  def actionGetReportsDataCsv(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def actionGetReportsDataJson(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - aSystems,sSystem,sModuleName,iDateFrom,iDateTo,&aValues,&iMaxValueY,&iMinValueY

  ## Retorno
    - any
  """
  def getViewsOrVotes(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def sortArrayOfArraysAndSlice(%{}) do
    # TODO: Implementacao futura
