...
defmodule DeeperHub.Inc.Classes.BxFilesModule do
  ...
  ## Parametros
    - sToken='',iContentId=0,sBulk=''

  ## Retorno
    - any
  """
  def actionDownload(%{}) do
    # TODO: Implementacao futura
  ...
  @doc """
  Funcao correspondente ao metodo PHP _addFileFields
  ...
  ## Retorno
    - any
  """
  def serviceEntityFilePreview(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceProcessFilesData(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def servicePruneDownloadingJobs(%{}) do
    # TODO: Implementacao futura
