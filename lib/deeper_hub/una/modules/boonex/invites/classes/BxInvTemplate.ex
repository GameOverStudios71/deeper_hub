...
defmodule DeeperHub.Inc.Classes.BxInvTemplate do
  ...
  ## Parametros
    - iAccountId,iProfileId,bRedirect=false

  ## Retorno
    - any
  """
  def getBlockInvite(%{}) do
    # TODO: Implementacao futura
