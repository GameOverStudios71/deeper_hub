...
defmodule DeeperHub.Inc.Classes.BxStrmEngineOvenMediaEngine do
  ...
  ## Parametros
    - iRecordingId,sStreamKey

  ## Retorno
    - any
  """
  def startRecording(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iRecordingId,aContentInfo,oModule,iTries=0

  ## Retorno
    - any
  """
  def processRecordings(%{}) do
    # TODO: Implementacao futura
