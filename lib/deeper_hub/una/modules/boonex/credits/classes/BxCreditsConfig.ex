...
defmodule DeeperHub.Inc.Classes.BxCreditsConfig do
  ...
  ## Retorno
    - any
  """
  def getTransferTypesForClearing(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def getTransferTypesForSpending(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def getConversionRateWithdraw(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def constructCheckoutCustomData(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def deconstructCheckoutCustomData(%{}) do
    # TODO: Implementacao futura
