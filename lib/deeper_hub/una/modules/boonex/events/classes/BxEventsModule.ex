...
defmodule DeeperHub.Inc.Classes.BxEventsModule do
  ...
  ## Retorno
    - any
  """
  def serviceIsIcalExportAvaliable(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceBrowseUpcomingProfiles(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceBrowseUpcomingConnectedProfiles(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - bDisplayEmptyMsg=false,bAjaxPaginate=true

  ## Retorno
    - any
  """
  def serviceBrowsePastProfiles(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceBrowsePastProfilesByParams(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - aData=[],sTemplate='calendar.html'

  ## Retorno
    - any
  """
  def serviceCalendar(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceProcessReminders(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceGetNotificationsReminder(%{}) do
    # TODO: Implementacao futura
