...
defmodule DeeperHub.Inc.Classes.BxDolAcl do
  ...
  ## Parametros
    - sContentField,mixedLevelId

  ## Retorno
    - any
  """
  def getContentByLevelAsCondition(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - mixedPermissions,iProfileId=false

  ## Retorno
    - any
  """
  def isMemberLevelInSet(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iProfileId,iActionId,bPerformAction=false
  ...
  ## Parametros
    - iProfileId,iActionId

  ## Retorno
    - any
  """
  def getActionNumberLeft(%{}) do
    # TODO: Implementacao futura
        # 
  ...
  ## Parametros
    - bPurchasableOnly=false,bActiveOnly=false,isTranslate=true,bFilterOutSystemAutomaticLevels=false

  ## Retorno
    - any
  """
  def getMemberships(%{}) do
    # TODO: Implementacao futura
        # 
  ...
  ## Parametros
    - iProfileId,iTime=0,bClearCache=0

  ## Retorno
    - any
  """
  def getMemberMembershipInfo(%{}) do
    # TODO: Implementacao futura
        # 
  ...
  ## Parametros
    - iProfileId,iLevelId,mixedPeriod=0,bStartsNow=false,sTransactionId=''

  ## Retorno
    - any
  """
  def setMembership(%{}) do
    # TODO: Implementacao futura
        # 
  ...
  ## Parametros
    - iProfileId,iLevelId,sTransactionId

  ## Retorno
    - any
  """
  def unsetMembership(%{}) do
    # TODO: Implementacao futura
        # 
    # 
  ...
  ## Parametros
    - iProfileId,sLevelName,iLevelExpireDays

  ## Retorno
    - any
  """
  def getExpirationLetter(%{}) do
    # TODO: Implementacao futura
        # 
    # 
  ...
  ## Retorno
    - any
  """
  def getMemberMembershipInfoCurrent(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def getMemberMembershipInfoLatest(%{}) do
    # TODO: Implementacao futura
