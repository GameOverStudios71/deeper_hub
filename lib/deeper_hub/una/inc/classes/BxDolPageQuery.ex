...
defmodule DeeperHub.Inc.Classes.BxDolPageQuery do
  ...
  ## Parametros
    - sURI,sModule=false,bSearchRedirects=false

  ## Retorno
    - any
  """
  def getPageObjectNameByURI(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def getContentInfoObjectNameByURI(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def getPageBlockContentPlaceholder(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sModule,sPageUri,sSeoParamName,sSeoParamValue,sUri

  ## Retorno
    - any
  """
  def insertSeoLink(%{}) do
    # TODO: Implementacao futura
