...
defmodule DeeperHub.Inc.Classes.BxDolProfileQuery do
  ...
  ## Parametros
    - iContentId,sType,iAccountId

  ## Retorno
    - any
  """
  def getProfileByContentTypeAccount(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iContentId,sType,bClearCache=false

  ## Retorno
    - any
  """
  def getProfileByContentAndType(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - aSqlParts,sType,iStart,iLimit

  ## Retorno
    - any
  """
  def getConnectedProfilesByType(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iAccountId,iContentId,sStatus,sType='system'
  ...
  ## Parametros
    - iProfileId,iAccountId

  ## Retorno
    - any
  """
  def changeAccountId(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iAccountId,bClearCache=false

  ## Retorno
    - any
  """
  def getCurrentProfileByAccount(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def getAccountInfoByProfileId(%{}) do
    # TODO: Implementacao futura
