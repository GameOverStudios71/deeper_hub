...
defmodule DeeperHub.Inc.Classes.BxDolRecommendationQuery do
  ...
  ## Parametros
    - iProfileId,iObjectId,bAll=false
  ...
  ## Parametros
    - iProfileId,iObjectId,iItemId,sItemType,iItemValue
  ...
  ## Parametros
    - iProfileId,iObjectId,iItemId,aSet
