...
defmodule DeeperHub.Inc.Classes.BxDolStorageS3 do
  ...
  ## Parametros
    - sRemoteId,sToken=false,bForceDownloadDialog='auto'
  ...
  ## Parametros
    - iFileId,isPrivate=true

  ## Retorno
    - any
  """
  def setFilePrivate(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sFileName,isPrivate,sMimeType=''

  ## Retorno
    - any
  """
  def generateHeaders(%{}) do
    # TODO: Implementacao futura
