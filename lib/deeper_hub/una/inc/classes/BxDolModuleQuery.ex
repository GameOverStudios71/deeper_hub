...
defmodule DeeperHub.Inc.Classes.BxDolModuleQuery do
  ...
  ## Parametros
    - sUri,bFromCache=true

  ## Retorno
    - any
  """
  def getModuleByUri(%{}) do
    # TODO: Implementacao futura
        # 
  ...
  ## Parametros
    - sName,sUri,sPath,sPrefixDb,sPrefixClass

  ## Retorno
    - any
  """
  def isModuleParamsUsed(%{}) do
    # TODO: Implementacao futura
        # 
