...
defmodule DeeperHub.Inc.Classes.BxDolPrivacyQuery do
  ...
  ## Parametros
    - sModule,sAction,iOwnerId

  ## Retorno
    - any
  """
  def getDefaultGroupByUser(%{}) do
    # TODO: Implementacao futura
        # 
    # 
  ...
  ## Parametros
    - iActionId,iOwnerId,iGroupId

  ## Retorno
    - any
  """
  def replaceDefaulfGroup(%{}) do
    # TODO: Implementacao futura
        # 
    # 
  ...
  ## Retorno
    - any
  """
  def insertGroupCustomMember(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def deleteGroupCustomMember(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def insertGroupCustomMembership(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def deleteGroupCustomMembership(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sField,mixedContextId

  ## Retorno
    - any
  """
  def getContentByContextAsSQLPart(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - sField,mixedGroupId,mixedContextId

  ## Retorno
    - any
  """
  def getContentByGroupAndContextAsSQLPart(%{}) do
    # TODO: Implementacao futura
