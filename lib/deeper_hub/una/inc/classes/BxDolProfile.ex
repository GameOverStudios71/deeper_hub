...
defmodule DeeperHub.Inc.Classes.BxDolProfile do
  ...
  ## Parametros
    - iAccountId=false,bClearCache=false

  ## Retorno
    - any
  """
  def getInstanceAccountProfile(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iContent,sType,iAccountId=false

  ## Retorno
    - any
  """
  def getInstanceByContentTypeAccount(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iContent,sType,bClearCache=false

  ## Retorno
    - any
  """
  def getInstanceByContentAndType(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def checkAllowedProfileView(%{}) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def checkAllowedProfileContact(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - iProfileId=0,sPostModule=''

  ## Retorno
    - any
  """
  def checkAllowedPostInProfile(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - ID=false,bDeleteWithContent=false,bForceDelete=false
  ...
  ## Parametros
    - iAction,iAccountId,iContentId,sStatus,sType='system'
  ...
  ## Parametros
    - iAction,iProfileId=0,bSendEmailNotification=true
  ...
  ## Parametros
    - sStatus,sAlertActionName,iAction,iProfileId=0,bSendEmailNotification=true
  ...
  ## Retorno
    - any
  """
  def getSwitchToProfileRedirectUrl(%{}) do
    # TODO: Implementacao futura
  ...
  ## Parametros
    - oTemplate=null,iViewerAccountId=false,iViewerProfileId=false

  ## Retorno
    - any
  """
  def checkSwitchToProfile(%{}) do
    # TODO: Implementacao futura
