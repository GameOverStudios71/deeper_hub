...
defmodule DeeperHub.Inc.Classes.BxDolModule do
  ...
  ## Retorno
    - any
  """
  def serviceIsSafeService(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceIsPublicService(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceGetPublicServices(params) do
    # TODO: Implementacao futura
