...
defmodule DeeperHub.Inc.Classes.BxDolModuleTemplate do
  ...
  ## Parametros
    - $mixedFiles
    -  $bDynamic = false
    -  $bSearchInModule = true

  ## Retorno
    - any
  """
  def addStudioCss(params) do
    # TODO: Implementacao futura
        # 
    # 
  ...
  ## Retorno
    - any
  """
  def addStudioCssSystem(params) do
    # TODO: Implementacao futura
        # 
    # 
  ...
  ## Retorno
    - any
  """
  def addStudioJsSystem(params) do
    # TODO: Implementacao futura
        # 
    # 
  ...
  ## Retorno
    - any
  """
  def addStudioJsTranslation(params) do
    # TODO: Implementacao futura
        # 
    # 
  ...
  ## Retorno
    - any
  """
  def addStudioInjection(params) do
    # TODO: Implementacao futura
        # 
    # 
