...
defmodule DeeperHub.Inc.Classes.BxInvConfig do
  ...
  ## Retorno
    - any
  """
  def getRequestsEmail(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def isRegistrationByInvitation(params) do
    # TODO: Implementacao futura
