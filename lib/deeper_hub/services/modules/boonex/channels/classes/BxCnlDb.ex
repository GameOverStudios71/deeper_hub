...
defmodule DeeperHub.Inc.Classes.BxCnlDb do
  ...
  ## Retorno
    - any
  """
  def getChannelIdByName(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def getChannelInfoByName(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def addContentToChannel(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def checkContentInChannel(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def getDataByContent(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def removeChannelContent(params) do
    # TODO: Implementacao futura
