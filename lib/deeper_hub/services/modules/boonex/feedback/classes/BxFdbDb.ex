...
defmodule DeeperHub.Inc.Classes.BxFdbDb do
  ...
  ## Retorno
    - any
  """
  def deleteAnswerById(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def insertAnswer2User(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def deleteAnswer2User(params) do
    # TODO: Implementacao futura
