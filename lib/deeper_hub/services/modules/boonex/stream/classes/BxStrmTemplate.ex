...
defmodule DeeperHub.Inc.Classes.BxStrmTemplate do
  ...
  ## Retorno
    - any
  """
  def entryStreamBroadcast(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def entryStreamViewers(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def entryStreamPlayer(params) do
    # TODO: Implementacao futura
