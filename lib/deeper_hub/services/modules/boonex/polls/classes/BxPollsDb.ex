...
defmodule DeeperHub.Inc.Classes.BxPollsDb do
  ...
  ## Retorno
    - any
  """
  def getContentInfoBySubentryId(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def deleteSubentryById(params) do
    # TODO: Implementacao futura
