...
defmodule DeeperHub.Inc.Classes.BxDonationsModule do
  ...
  ## Retorno
    - any
  """
  def serviceGetTypesBy(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceIncludeCssJs(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceGetBlockMake(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def serviceGetBlockList(params) do
    # TODO: Implementacao futura
