...
defmodule DeeperHub.Inc.Classes.BxBaseModPaymentTemplate do
  ...
  ## Retorno
    - any
  """
  def displayPageCodeResponse(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def displayPageCodeError(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def displayProfileLink(params) do
    # TODO: Implementacao futura
  ...
  ## Retorno
    - any
  """
  def displayPageCodeText(params) do
    # TODO: Implementacao futura
