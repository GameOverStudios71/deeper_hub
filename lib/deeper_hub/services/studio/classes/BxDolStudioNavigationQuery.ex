...
defmodule DeeperHub.Inc.Classes.BxDolStudioNavigationQuery do
  ...
  ## Retorno
    - any
  """
  def updateMenuByObject(params) do
    # TODO: Implementacao futura
        # 
    #     
  ...
  ## Retorno
    - any
  """
  def updateItemBySetAndName(params) do
    # TODO: Implementacao futura
        # 
    # 
